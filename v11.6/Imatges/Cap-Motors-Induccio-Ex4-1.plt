...
set output "Cap-Motors-Induccio-Ex4-1.tex"
...
set label '{$\scriptstyle\SI{60,7}{N.m}$}' at 300, 63.7 center norotate front
set arrow from 1157.62, 132.70 to 0.0, 132.7 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\SI{132,7}{N.m}$}' at 300, 135.7 center norotate front
set arrow from 1425.0, 60.70 to 1425.0, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\SI{1425}{r/min}$}' at 1408, 18 center rotate by -270 front
set arrow from 1157.62, 132.70 to 1157.62, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\SI{1157,6}{r/min}$}' at 1140, 20 center rotate by -270 front
set arrow from 1275, second 17.67 to 1500, second 17.67 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\SI{17,7}{A}$}' at 1325, second 19 center front
plot "Cap-Motors-Induccio-Ex4-1.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$T\ped{m}$', "Cap-Motors-Induccio-Ex4-1.txt" using 1:3 with lines axes x1y2 linecolor rgb "sea-green"  linewidth 6.000 title '$I_1$'
#    EOF
