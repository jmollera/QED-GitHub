...
set output "Cap-Motors-Induccio-Ex6-1.tex"
...
set label '{$\scriptstyle\SI{9,7}{A}$}' at 0.85, 0.026 center front
...
plot "Cap-Motors-Induccio-Ex6.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$s$', "Cap-Motors-Induccio-Ex6.txt" using 1:3 with lines axes x1y2 linecolor rgb "sea-green"  linewidth 6.000 title '$I_1$'
#    EOF
