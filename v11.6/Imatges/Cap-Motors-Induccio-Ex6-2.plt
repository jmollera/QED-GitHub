...
set output "Cap-Motors-Induccio-Ex6-2.tex"
...
plot "Cap-Motors-Induccio-Ex6.txt" using 1:4 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$\cos\varphi$', "Cap-Motors-Induccio-Ex6.txt" using 1:5 with lines axes x1y1 linecolor rgb "sea-green"  linewidth 6.000 title '$\eta$'
#    EOF
