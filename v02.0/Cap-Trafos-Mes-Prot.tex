...
\hspace{1.5cm}
\input{Imatges/Cap-Trafos-Mes-Prot-TI-TT.pst}
...
\begin{figure}[h]
\centering
    \input{Imatges/Cap-Trafos-Mes-Prot-Watt.pst}
\end{figure}
...
\begin{figure}[h]
\centering
    \input{Imatges/Cap-Trafos-Mes-Prot-Instal.pst}
\end{figure}
...
\begin{figure}[h]
\centering
    \input{Imatges/Cap-Trafos-Mes-Prot-Instal-Watt.pst}
\end{figure}
