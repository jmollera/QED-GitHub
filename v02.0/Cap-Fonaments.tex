...
%\vspace{0.25cm}
\centering
    \input{Imatges/Cap-Fonaments-Thevenin.pst}
...
\centering
    ...
    \rput[r](105,12){$\cmplx{J}\ped{No}$} \rput(109,12){}
...
\input{Imatges/Cap-Fonaments-Millman-Exemple.pst}
...
\begin{exemple}
    ...
    \begin{figure}[htb]
        \centering
        \input{Imatges/Cap-Fonaments-Exemple-Superposicio-1.pst}
    \end{figure}
    ...
    \begin{figure}[htb]
        \centering
        \input{Imatges/Cap-Fonaments-Exemple-Superposicio-2.pst}
    \end{figure}
...
\hfill
\begin{minipage}[b]{5cm}
    \input{Imatges/Cap-Fonaments-Capacitat.pst}
...
\begin{minipage}[b]{6cm}
   \input{Imatges/Cap-Fonaments-Acobl-Magnetic.pst}
...
\hfill
\begin{minipage}[b]{6cm}
    \input{Imatges/Cap-Fonaments-Trafo-Ideal.pst}
...
\hfill
\begin{minipage}[b]{5cm}
    \input{Imatges/Cap-Fonaments-Bateria.pst}
...
\begin{figure}[htb]
\centering
    \input{Imatges/Cap-Fonaments-Divisor-Tensio.pst}
...
\begin{figure}[htb]
\centering
    \input{Imatges/Cap-Fonaments-Divisor-Corrent.pst}
