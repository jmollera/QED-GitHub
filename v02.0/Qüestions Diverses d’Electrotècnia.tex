...
\usepackage{pst-plot}
\usepackage{pst-math}
\usepackage[pstricks,final]{pst-pdf}
\usepackage{pstricks-add}


\newtheorem{exemple}{\sffamily\color{NavyBlue}Exemple}[chapter]  % defineix l'entorn "Exemple"
...
\begin{document}
   ...
   \part{Ap\`{e}ndixs}
      ...
      \include{Ape-Escales-Log}
      \include{Ape-Funcions-Trigonometriques}
      \include{Ape-Proteccio-IP}
      \include{Ape-Classes-NEMA}
      \include{Ape-Classes-Refrigeracio-Trafos}
   \backmatter
   \printindex
\end{document}
