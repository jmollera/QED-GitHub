...
set xtics 0.0,10.0,100.0 norangelimit textcolor rgb "black" 
set ytics border out scale 1,0.5 nomirror norotate  autojustify
set ytics -12.0,3.0,12.0 norangelimit textcolor rgb "black"
...
set y2tics 0.0,0.25,2.0 norangelimit textcolor rgb "black" 
...
set xrange [ 0.0000 : 100.0 ] noreverse nowriteback
set x2range [ 0.0000 : 100.0 ] noreverse nowriteback
set ylabel '$u(t)\, / \,\unit{V}$' 
set ylabel  font "" textcolor lt -1 rotate by -270
set y2label '$i(t)\, / \,\unit{A}$' offset 2,0
set y2label  font "" textcolor lt -1 rotate by -270
set yrange [-12.0000 : 12.0000 ] noreverse nowriteback
set y2range [0.0000 : 2.0000 ] noreverse nowriteback
set zlabel "" 
...
set output "Cap-Fonaments-RL-Carrega-Descarrega.tex"
set object rectangle from 0,-12 to 100,12 fillstyle solid fillcolor rgb "#FFFFF0" behind
i1(t)=2-2*exp(-t*1e-3/0.010)
i2(t) = i1(20)*exp(-(t*1e-3-0.020)/0.015)
i3(t) = 2-(2-i2(40))*exp(-(t*1e-3-0.040)/0.010)
i(t) = t<20 ? i1(t) : t<40 ? i2(t) : i3(t) 
u1(t) =12*exp(-t*1e-3/0.010)
u2(t) = -4*i1(20)*exp(-(t*1e-3-0.020)/0.015)
u3(t) = (12-6*i2(40))*exp(-(t*1e-3-0.040)/0.010)
u(t) = t<20 ? u1(t) : t<40 ? u2(t) : u3(t) 
plot i(x) axes x1y2 linecolor rgb "red"  linewidth 6.000 title '$i(t)$', u(x) axes x1y1 linecolor rgb "sea-green" linewidth 6.000 title '$u(t)$'
#    EOF
