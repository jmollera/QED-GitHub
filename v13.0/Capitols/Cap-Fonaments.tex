...
\begin{exemple}[Curtcircuit en un circuit R-L]\label{ex:cc-RL}
    ...
    Finalment, donat que es compleix $\phi=0$ i $\omega L \,(\qty{157,2e-4}{\ohm}) \gg R\, (\qty{9e-4}{\ohm}) $, podem utilitzar les equacions \eqref{eq:I_asim_pic} i \eqref{eq:I_asim_eff}:
    \begin{align*}
