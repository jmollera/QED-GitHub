...
La banda de color que indica el coeficient de temperatura només s'utilitza en les resistències  que tenen un valor resistiu  definit per tres dígits, segons el paràgraf anterior, i se situa a la dreta de la banda que indica la tolerància, passant a ser, per tant, la sisena banda.
   ...
   definides pels colors:
    ...
    \begin{align*}
      ...
      \end{minipage}  \,  &
       ...
       \end{cases}
	    \intertext{c) En aquest  cas  tenim:}
	   \begin{minipage}{1.8cm}
	   	\includegraphics{Cap-Resistencies-R3.pdf}
	   \end{minipage} \,  &
	   \begin{cases}
