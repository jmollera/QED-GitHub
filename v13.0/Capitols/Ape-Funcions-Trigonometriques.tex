...
La llei dels sinus ens dona la relació següent:\index{llei dels
sinus}
\begin{equation}
...
La llei dels cosinus ens dona les relacions següents:\index{llei
dels cosinus}
\begin{subequations}
\begin{align}
...
La llei de les tangents ens dona les relacions següents:\index{llei
de les tangents}
\begin{subequations}
\begin{align}
...
La llei de les cotangents ens dona la relació següent:\index{llei de les cotangents}
\begin{equation}
    \frac{b+c-a}{\cot\frac{\alpha}{2}} = \frac{a+c-b}{\cot\frac{\beta}{2}} =
    \frac{a+b-c}{\cot\frac{\gamma}{2}} = 2 r
\end{equation}

La fórmula de Mollweide, la qual lliga els tres costats amb els tres angles interiors d'un triangle, ens dona les relacions següents:\index{fórmula de Mollweide}
\begin{subequations}
\begin{align}
