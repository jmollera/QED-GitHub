...
\addcontentsxms{Resolució d'un circuit amb condicions inicial nuŀles}
    ...
    \begin{dingautolist}{'312}
        ...
        \item Per començar premem la tecla \includegraphics{HPPrime-CAS.pdf} \textit{computer algebra system}, per tal de posar la calculadora en el mode de resolució simbòlic; a continuació premem la tecla \includegraphics{HPPrime-Tool.pdf} i escollim \funsfbs{Inverse Laplace} (funció \funsfbs{ilaplace}).
