...
\begin{exemple}[Flux de càrrega d'una xarxa]
	\addcontentsxms{Flux de càrrega d'una xarxa}
...
\begin{exemple}[Control de tensió d'un nus amb condensadors]\label{ex:control-v-cond}
	\addcontentsxms{Control de tensió d'un nus amb condensadors}
...
\begin{exemple}[Control de tensió d'un nus amb un transformador]
	\addcontentsxms{Control de tensió d'un nus amb un transformador}
...
La resolució amb el programa \emph{MATLAB®} no és tan senzilla, i s'obté a partir de la funció  \funsfbs{fsolve}. Per  poder utilitzar aquesta funció cal tenir instaŀlada l'extensió del programa \textit{Optimization toolbox}.
