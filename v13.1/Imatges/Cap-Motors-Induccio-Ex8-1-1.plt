...
plot "Cap-Motors-Induccio-Ex8-1.txt" using 1:2 with lines axes x1y1 linecolor rgb "black" linewidth 6.000 title '$T\ped{load}$', "Cap-Motors-Induccio-Ex8-1.txt" using 1:3 with lines axes x1y1 linecolor rgb "red"  linewidth 6.000 title '$T\ped{m,\qty{100}{\%}}$', "Cap-Motors-Induccio-Ex8-1.txt" using 1:4 with lines axes x1y1 linecolor rgb "sea-green"  linewidth 6.000 title '$T\ped{m,\qty{80}{\%}}$', "Cap-Motors-Induccio-Ex8-1.txt" using 1:5 with lines axes x1y2 linecolor rgb "orange"  linewidth 6.000 title '$I\ped{1,\qty{100}{\%}}$', "Cap-Motors-Induccio-Ex8-1.txt" using 1:6 with lines axes x1y2 linecolor rgb "green"  linewidth 6.000 title '$I\ped{1,\qty{80}{\%}}$'
#    EOF
