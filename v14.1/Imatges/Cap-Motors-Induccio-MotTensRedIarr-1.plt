...
set arrow from 1428.0, 56.4 to 0.0, 56.4 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{56,4}{N.m}$}' at 150, 52.5 center norotate front
set arrow from 1428.0, 56.4 to 1428.0, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1428}{r/min}$}' at 1412, 18 center rotate by -270 front
