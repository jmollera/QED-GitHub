...
set ytics 204.0,2.0,220.0 norangelimit textcolor rgb "black" 
...
set yrange [ 204.000 : 220.000 ] noreverse nowriteback
...
set object rectangle from 0,204 to 1500,220 fillstyle solid fillcolor rgb "#FFFFF0" behind
set arrow from 1428.0, 214.305 to 0.0, 214.305 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{214,305}{V}$}' at 150, 214.6 center norotate front
set arrow from 1428.0, 214.305 to 1428.0, 204.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1428}{r/min}$}' at 1412, 206 center rotate by -270 front
