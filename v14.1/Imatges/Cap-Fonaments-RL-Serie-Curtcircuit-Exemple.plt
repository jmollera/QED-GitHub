...
set key noinvert samplen 2 spacing 1.5 width 0 height 0.5 
...
set xtics 0.00000,20,200.000 norangelimit textcolor rgb "black" 
set ytics border out scale 1,0.5 nomirror norotate  autojustify
set ytics -40.0000,20,80.0000 norangelimit textcolor rgb "black" 
...
set ylabel  '$i\ped{dc}(t)\, / \,\unit{kA}, \quad i\ped{ac}(t)\, / \,\unit{kA}, \quad i(t)\, / \,\unit{kA}$'offset -1,0
set ylabel  font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  font "" textcolor lt -1 rotate by -270
set yrange [ -40.0000 : 80.0000 ] noreverse nowriteback
set y2range [ -40.0000 : 80.0000 ] noreverse nowriteback
set zlabel "" 
...
ARGC = 0
ARG0 = ""
set terminal cairolatex pdf size 14.5cm,8.5cm
set output "Cap-Fonaments-RL-Serie-Curtcircuit-Exemple.tex"
set object rectangle from 0,-40 to 200,80 fillstyle solid fillcolor rgb "#FFFFF0" behind
idc(x) = 35.8948169*exp(-0.018*x)
iac(x) = 35.9536865*sin(0.3141593*x-1.5136)
plot  idc(x) linecolor rgb "sea-green" linewidth 6.000 title '$i\ped{dc}(t)$', iac(x)  linecolor rgb "orange" linewidth 6.000 title '$i\ped{ac}(t)$', iac(x)+idc(x) linecolor rgb "red" linewidth 6.000 title '$i(t)$'
#    EOF
