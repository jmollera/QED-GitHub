...
set arrow from 0.8, 0.871 to 0.8,  0.76 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,8}$}' at 0.796, 0.77 center rotate by -270 front
set arrow from 0.8,  0.871 to 0.75,  0.871 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,871}$}' at 0.775, 0.874 center front
set arrow from 0.8, 0.816 to 0.75, 0.816 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,816}$}' at 0.775, 0.812 center front
