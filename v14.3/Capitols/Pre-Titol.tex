...
\begin{titlepage}
	\parbox{18cm}{\fontsize{60pt}{60pt}\selectfont\color{red}\scshape%
		...
		\hspace*{10.5cm}\includegraphics[scale=0.4]{Pre-python-powered-w.pdf}\\
		\fontsize{30pt}{30pt}\selectfont{}Josep Mollera Barriga}
	\vspace*{10mm}
	\begin{center}
...
{\fontsize{40pt}{40pt}\selectfont
	2005-2023 \hspace{5mm}{\Huge(versió 14.3)}\\[85pt]
