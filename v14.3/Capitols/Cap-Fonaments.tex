...
\begin{exemple}[\MillmanTrifNeutre{} \hyperlink{exemple:MillmanTrifNeutre}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:MillmanTrifNeutre}
    ...
    \dfrac{\qtypd{230}{120}{V}}{\qty{70}{m\ohm}} + 0}{\dfrac{1}{\qty{50}{m\ohm}}+\dfrac{1}{\qty{80}{m\ohm}}+
    \dfrac{1}{\qty{70}{m\ohm}}+\dfrac{1}{\qty{46}{\ohm}}} =
    \qtypd{33,3433}{13,17}{V}
    \]
    ...
    = \qtypd{0,7249}{13,17}{A}
    \]

    Finalment, els corrents que circulen per cadascuna de les tres càrregues val:
    \begin{align*}
    \cmplx{I}\ped{A} &= \frac{\cmplx{U}\ped{AG}}{R\ped{A}} = \frac{\cmplx{U}\ped{AN} - \cmplx{U}\ped{GN}}{R\ped{A}} = \frac{\qtypd{230}{0}{V}-\qtypd{33,3433}{13,17}{V}}{\qty{50}{m\ohm}}
    = \qtypd{3953,6056}{-2,20}{A}\\[2ex]
    \cmplx{I}\ped{B} &= \frac{\cmplx{U}\ped{BG}}{R\ped{B}} = \frac{\cmplx{U}\ped{BN} - \cmplx{U}\ped{GN}}{R\ped{B}} = \frac{\qtypd{230}{240}{V}-\qtypd{33,3433}{13,17}{V}}{\qty{80}{m\ohm}}
    = \qtypd{3174,7573}{-125,49}{A}\\[2ex]
    \cmplx{I}\ped{C} &= \frac{\cmplx{U}\ped{CG}}{R\ped{C}} = \frac{\cmplx{U}\ped{CN} - \cmplx{U}\ped{GN}}{R\ped{C}} = \frac{\qtypd{230}{120}{V}-\qtypd{33,3433}{13,17}{V}}{\qty{70}{m\ohm}}
    = \qtypd{3453,8265}{127,59}{A}
    \end{align*}
\end{exemple}
...
\begin{exemple}[\MillmanTrifNoNeutre{}]
    ...
    \begin{align*}
    \cmplx{I}\ped{A} &= \frac{\cmplx{U}\ped{AK}}{R\ped{A}} = \frac{\cmplx{U}\ped{AN} - \cmplx{U}\ped{KN}}{R\ped{A}} = \frac{\qtypd{230}{0}{V}-\qtypd{33,3588}{13,17}{V}}{\qty{50}{m\ohm}}
    = \qtypd{3953,3068}{-2,20}{A}\\[2ex]
    \cmplx{I}\ped{B} &= \frac{\cmplx{U}\ped{BK}}{R\ped{B}} = \frac{\cmplx{U}\ped{BN} - \cmplx{U}\ped{KN}}{R\ped{B}} = \frac{\qtypd{230}{240}{V}-\qtypd{33,3588}{13,17}{V}}{\qty{80}{m\ohm}}
    = \qtypd{3174,9027}{-125,50}{A}\\[2ex]
    \cmplx{I}\ped{C} &= \frac{\cmplx{U}\ped{CK}}{R\ped{C}} = \frac{\cmplx{U}\ped{CN} - \cmplx{U}\ped{KN}}{R\ped{C}} = \frac{\qtypd{230}{120}{V}-\qtypd{33,3588}{13,17}{V}}{\qty{70}{m\ohm}}
    = \qtypd{3453,9180}{127,59}{A}
    \end{align*}
\end{exemple}
...
\begin{exemple}[\ValorEfValorMitja{}]\label{ex:ValEfMit}
	...
	Per tant, només cal multiplicar per 1,11 el valor mesurat pel voltímetre (valor rectificat mitjà) per tal d'obtenir el valor desitjat (valor sinusoidal eficaç). De fet, en aquests voltímetres la caràtula ja està ajustada amb aquest factor de 1,11, de manera que la lectura és directament el valor eficaç.
\end{exemple}
...
\begin{exemple}[\CarDescRL{} \hyperlink{exemple:CarDescRL}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:CarDescRL}
    ...
    El circuit  següent té un commutador que en l'instant $t=0$ bascula cap a la posició A; a continuació, en l'instant $t=\qty{20}{ms}$ el commutador bascula cap a la posició B; finalment, en  l'instant $t=\qty{40}{ms}$ el commutador torna a  bascular cap a la posició A i s'hi queda.     Es tracta de trobar les equacions del corrent $i(t)$ i la tensió $u(t)$ en la inductància.
    \vspace{-2mm}
   	\begin{center}
   ...
   \end{center}
    ...
    \begin{dingautolist}{'312}
        ...
        \item Tot seguit entrem en els camps \textsfs{F1(X)}, \textsfs{F2(X)} i \textsfs{F3(X)} les equacions de $i_1(t)$, $i_2(t)$ i $i_3(t)$; en lloc dels valors \num{1,7293} i  \num{0,4558}, utilitzarem \textsfs{F1(0.02)} i \textsfs{F2(0.04)} respectivament, per tal que la calculadora els calculi automàticament. Com a variable utilitzarem \textsfs{X} en lloc de \textsfs{t}.
            ...
            En el camp \textsfs{F4(X)} entrem la funció $i(t)$, amb l'ajut de la funció  \textsfs{Heaviside(X)}. Escriurem:\break \textsfs{F1(X) * (Heaviside(X--0)--Heaviside(X--0.02)) + F2(X) * (Heaviside(X--0.02)--Heaviside(X--0.04))+ F3(X) *\break \textsf{} Heaviside(X--0.04)}.
