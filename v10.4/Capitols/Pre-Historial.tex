...
Es crea el nou apèndix F, dedicat a programes per a la calculadora HP Prime de Hewlett-Packard. S'eliminen els programes que en les versions anteriors estaven llistats en l'exemple \ref{ex:res-circ-pot} i en la secció \ref{sec:calcul-comp-sim}, incorporant-se en aquest nou apèndix.

S'afegeix un nou exemple al final de la secció \ref{sec:poli_lagr}, dedicat  a la interpolació en dues dimensions. 