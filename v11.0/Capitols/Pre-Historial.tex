...
Es crea un nou capítol \ref{sec:motors-ind} dedicat als motors d'inducció trifàsics.
...
En l'apèndix \ref{sec:progs-HP} s'afegeix l'adreça de la pàgina de Hewlett-Packard des d'on pot descarregar-se un emulador per a PC de la calculadora \emph{HP Prime}; s'afegeix a més la funció \funsfbs{Regla\_dels\_Trapezis}.
