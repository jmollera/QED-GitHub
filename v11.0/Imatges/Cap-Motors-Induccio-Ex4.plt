...
ARGC = 0
ARG0 = ""
set terminal cairolatex pdf size 17cm,9cm
set output "Cap-Motors-Induccio-Ex4.tex"
set arrow from 1425.0, 60.70 to 0.0, 60.7 dt 2 linecolor rgb "dark-violet" linewidth 2.0 head noborder back
set label '{$\scriptstyle\SI{60,7}{N.m}$}' at 300, 63.7 center norotate front
set arrow from 1157.62, 132.70 to 0.0, 132.7 dt 2 linecolor rgb "dark-violet" linewidth 2.0 head noborder back
set label '{$\scriptstyle\SI{132,7}{N.m}$}' at 300, 135.7 center norotate front
set arrow from 1425.0, 60.70 to 1425.0, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 2.0 head noborder back
set label '{$\scriptstyle\SI{1425}{r/min}$}' at 1408, 20 center rotate by -270 front
set arrow from 1157.62, 132.70 to 1157.62, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 2.0 head noborder back
