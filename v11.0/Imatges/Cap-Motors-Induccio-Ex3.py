...
try:
    with open("Cap-Motors-Induccio-Ex3-1.txt", "w", encoding="utf8") as fh:
...
try:
    with open("Cap-Motors-Induccio-Ex3-2.txt", "w", encoding="utf8") as fh:
        for i in range(len(ω)):
            fh.write(locale.format_string(
                    "%7.3f  &  %7.3f  &  %7.3f  &  %8.6f  \\\\ \n",
...
# tarr s - integració pel mètode de simpson
tarr = J*integrate.trapz(1/Tacc, ω)
