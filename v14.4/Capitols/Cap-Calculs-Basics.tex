...
\section{Transformació estrella-triangle d'impedàncies}\label{secc:d_y} \index{transformació
...
\begin{exemple}[\ResCircPotAbs{} \hyperlink{exemple:ResCircPotAbs}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:ResCircPotAbs}
    ...
    \item Premem a continuació la tecla \includegraphics{HPPrime-Enter.pdf} i la calculadora ens dona el valor de la tensió $\cmplx{U}$.
     ...
     \item   Si la calculadora estigués en el mode \textsfs{Algebraic} o en el mode  \textsfs{Textbook}, escriuríem directament: \textsfs{EZS\_U(0.4+0.3*i,0.1*i,0.6+0.45*i)}, i després de prémer la tecla \includegraphics{HPPrime-Enter.pdf} la calculadora ens donaria el valor de la tensió $\cmplx{U}$.
