...
class Motor3ph:
    ...
    def start_up(self, T_load, J, e_ext, z_ext=0):
        ...
        t_start:    The starting time of the motor, s
        s_start_up: An interpolating function (scipy.interpolate.interp1d) that returns the
                    slip for a given time t in seconds. For t < 0, the slip at t = 0 is returned;
                    for t > t_start, the slip at t = t_start is returned.
        """
        n_p1, n_p2 = 200, 800
        ...
        t_start = t[-1]
        s_start_up = interpolate.interp1d(t, s, kind='cubic', copy=False, assume_sorted=True,
