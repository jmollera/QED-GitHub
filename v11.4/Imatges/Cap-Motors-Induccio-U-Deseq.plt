...
set xtics 0.0,0.5,5.0 norangelimit textcolor rgb "blackz" 
set ytics border out scale 1,0.5 nomirror norotate  autojustify
set ytics 0.70,0.05,1.05 norangelimit textcolor rgb "black" 
...
set y2tics 1.00,0.05,1.35 norangelimit textcolor rgb "black"
...
set xlabel '$\Deltaup u\, / \,\si{\%}$'
set xlabel  font "" textcolor lt -1 norotate
set x2label "" 
set x2label  font "" textcolor lt -1 norotate
set xrange [ 0.0000 : 5.0000 ] noreverse nowriteback
set x2range [ 0.0000 : 5.0000 ] noreverse nowriteback
set ylabel '$\kappa\ped{P}$' 
set ylabel  font "" textcolor lt -1 rotate by 0
set y2label '$\kappa\ped{I}$' 
set y2label  font "" textcolor lt -1 rotate by 0
set yrange [ 0.7000 : 1.0500 ] noreverse nowriteback
set y2range [ 1.0000 : 1.3500 ] noreverse nowriteback
set zlabel "" 
...
ARGC = 0
ARG0 = ""
set terminal cairolatex pdf size 16.5cm,9cm
set output "Cap-Motors-Induccio-U-Deseq.tex"
set object rectangle from 0.0,0.7 to 5.0,1.05 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot "Cap-Motors-Induccio-U-Deseq.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$\kappa\ped{P}$', "Cap-Motors-Induccio-U-Deseq.txt" using 1:3 with lines axes x1y2 linecolor rgb "sea-green"  linewidth 6.000 title '$\kappa\ped{I}$'
#    EOF
