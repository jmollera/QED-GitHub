...
\addcontentsxms{Càlcul de transformades de Laplace}
...
\addcontentsxms{Resolució d'un circuit R-C}
...
\addcontentsxms{Resolució d'un circuit amb condicions inicial no nuŀles}
...
\addcontentsxms{Resolució d'un circuit amb condicions inicial nuŀles}
