...
s_fun = sol.x[0]
U_1_fun = U_1(s_fun)
I_1_fun = abs(I_1(s_fun))
T_m_fun = T_m(s_fun)
print(f's,fun = {s_fun:.4f},  n_m,fun = {(1-s_fun)*n_m_sinc:.1f} r/min')
print(f'U_1,fun = {ComplexD(U_1_fun):.3f} V')
print(f'I_1,fun = {I_1_fun:.1f} A')
print(f'T_m,fun = {T_m_fun:.1f} N·m\n')

U_1_arr = U_1(1)
I_1_arr = abs(I_1(1))
T_m_arr = T_m(1)
print(f'U_1,arr = {ComplexD(U_1_arr):.3f} V')
print(f'I_1,arr = {I_1_arr:.1f} A')
