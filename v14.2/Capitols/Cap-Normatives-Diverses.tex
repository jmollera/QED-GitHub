...
\begin{list}{}
   {\setlength{\labelwidth}{15mm} \setlength{\leftmargin}{15mm} \setlength{\labelsep}{2mm}}
        \item[$\boldsymbol{M}$] Relació $\dfrac{I}{I\ped{P}}$. És adimensional.
        \item[$\boldsymbol{I}$] Corrent que circula per la protecció 51. S'expressa en A.\footnote{\label{fn:I-Ip}De fet, només cal que $I$ i $I\ped{P}$ estiguin expressats en les mateixes unitats (per exemple en kA), per tal  que el seu quocient sigui adimensional.}
        \item[$\boldsymbol{I\ped{P}}$] Paràmetre ajustable. És el valor de corrent a partir del qual la  protecció comença a actuar (\textit{pick-up current}). S'expressa en A.\footnoteref{fn:I-Ip}
        \item[$\boldsymbol{T}$] Paràmetre multiplicatiu ajustable. És adimensional.
        \item[$\boldsymbol{\alpha}$] Paràmetre ajustable que defineix la forma de la corba. És adimensional.
        \item[$\boldsymbol{k}$] Paràmetre ajustable que defineix la forma de la corba. S'expressa en s.
        \item[$\boldsymbol{C}$] Paràmetre ajustable que defineix la forma de la corba. S'expressa en s.
        \item[$\boldsymbol{B}$] Paràmetre additiu ajustable. S'expressa en s.
        \item[$\boldsymbol{t_{51}(I)}$] Temps que triga la protecció 51 a actuar quan circula un corrent $I$. S'expressa en s.
\end{list}
