...
{   morekeywords=[1]{EXPORT,BEGIN,END,LOCAL,RETURN,IF,THEN,ELSE,
	FOR,FROM,TO,DO},
	sensitive=true,
	morecomment=[l]{//},
	morestring=[b]"
...
\newcommand{\TriangleEstrella}{Transformació triangle $\rightarrow$ estrella}
...
\newcommand{\ConstantsEscalaLogLog}{Càlcul de les constants \textit{n} i \textit{k} en una escala logarítmica-logarítmica}
