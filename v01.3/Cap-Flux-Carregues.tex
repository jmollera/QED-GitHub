...
d'admit\`{a}ncies de node $\mcmplx{Y}\ped{N}$}
...
per les expressions:\index{linies@l\'{\i}nies el\`{e}ctriques!fluxos de
pot\`{e}ncia}
\begin{align}
...
\section{Tipus de nodes} \index{flux de c\`{a}rregues!tipus de nodes}
...
\begin{table}[htb]
   ...
   \toprule[1pt]
   \multirow{2}{15mm}{\rule{0mm}{4.5mm}Tipus\\de node}  & \multicolumn{2}{c}{Tensi\'{o}} &
