...
set output "Cap-Motors-Induccio-Ex4-3.tex"
...
set label '{$\scriptstyle\SI{1425}{r/min}$}' at 1408, 0.2 center rotate by -270 front
...
plot "Cap-Motors-Induccio-Ex4-3.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$\cos\varphi$', "Cap-Motors-Induccio-Ex4-3.txt" using 1:3 with lines axes x1y1 linecolor rgb "sea-green"  linewidth 6.000 title '$\eta$'
#    EOF
