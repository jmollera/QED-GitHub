...
set output "Cap-Motors-Induccio-Ex9-1.tex"
...
set label '{$\scriptstyle\SI{56,4}{N.m}$}' at 150, 52.5 center norotate front
set arrow from 1428.0, 56.4 to 1428.0, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\SI{1428}{r/min}$}' at 1412, 18 center rotate by -270 front
set arrow from 1170.5, 117.5 to 0.0, 117.5 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\SI{117,5}{N.m}$}' at 150, 113.2 center norotate front
set arrow from 1170.5, 117.5 to 1170.5, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\SI{1170,5}{r/min}$}' at 1155, 20 center rotate by -270 front
set arrow from 1275, second 16.85 to 1500, second 16.85 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\SI{16,9}{A}$}' at 1330, second 18 center front
plot "Cap-Motors-Induccio-Ex9.txt" using 1:2 with lines axes x1y1 linecolor rgb "black" linewidth 6.000 title '$T\ped{load}$', "Cap-Motors-Induccio-Ex9.txt" using 1:3 with lines axes x1y1 linecolor rgb "red"  linewidth 6.000 title '$T\ped{m}$', "Cap-Motors-Induccio-Ex9.txt" using 1:4 with lines axes x1y2 linecolor rgb "orange"  linewidth 6.000 title '$I_1$'
#    EOF
