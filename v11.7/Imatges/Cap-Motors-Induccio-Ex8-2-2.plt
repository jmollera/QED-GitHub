...
set output "Cap-Motors-Induccio-Ex8-2-2.tex"
set object rectangle from 0.75,0.82 to 1,0.9 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot "Cap-Motors-Induccio-Ex8-2.txt" using 1:4 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$\cos\varphi$', "Cap-Motors-Induccio-Ex8-2.txt" using 1:5 with lines axes x1y1 linecolor rgb "sea-green"  linewidth 6.000 title '$\eta$'
#    EOF
