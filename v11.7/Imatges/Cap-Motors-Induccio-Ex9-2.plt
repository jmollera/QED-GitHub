...
set ylabel  '$U_1\, / \,\si{V}, \quad U\ped{1,sist}\, / \,\si{V}$'
...
set output "Cap-Motors-Induccio-Ex9-2.tex"
...
set label '{$\scriptstyle\SI{214,305}{V}$}' at 150, 214.6 center norotate front
set arrow from 1428.0, 214.305 to 1428.0, 204.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\SI{1428}{r/min}$}' at 1412, 206 center rotate by -270 front
plot "Cap-Motors-Induccio-Ex9.txt" using 1:5 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$U_1$', 219.393 with lines axes x1y1 linecolor rgb "sea-green" linewidth 6.000 title '$U\ped{1,sist}$'
#    EOF
