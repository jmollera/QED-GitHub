...
set key noinvert samplen 1 spacing 1 width -2 height 0.25 
...
set output "Cap-Motors-Induccio-Ex8-1-1.tex"
set object rectangle from 0,0 to 1500,150 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot "Cap-Motors-Induccio-Ex8-1.txt" using 1:2 with lines axes x1y1 linecolor rgb "black" linewidth 6.000 title '$T\ped{load}$', "Cap-Motors-Induccio-Ex8-1.txt" using 1:3 with lines axes x1y1 linecolor rgb "red"  linewidth 6.000 title '$T\ped{m,\SI{100}{\%}}$', "Cap-Motors-Induccio-Ex8-1.txt" using 1:4 with lines axes x1y1 linecolor rgb "sea-green"  linewidth 6.000 title '$T\ped{m,\SI{80}{\%}}$', "Cap-Motors-Induccio-Ex8-1.txt" using 1:5 with lines axes x1y2 linecolor rgb "orange"  linewidth 6.000 title '$I\ped{1,\SI{100}{\%}}$', "Cap-Motors-Induccio-Ex8-1.txt" using 1:6 with lines axes x1y2 linecolor rgb "green"  linewidth 6.000 title '$I\ped{1,\SI{80}{\%}}$'
#    EOF
