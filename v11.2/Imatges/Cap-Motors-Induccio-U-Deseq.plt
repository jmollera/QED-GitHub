...
set xtics 0.0,0.5,5.0 norangelimit textcolor rgb "black" 
...
set ylabel '$\kappa\ped{P}$' offset 3,0
set ylabel  font "" textcolor lt -1 rotate by 0
set y2label '$\kappa\ped{I}$' offset -1.5,0
...
ARGC = 0
ARG0 = ""
set terminal cairolatex pdf size 18cm,9cm
