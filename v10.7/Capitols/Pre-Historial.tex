...
Es corregeix la posició del títol de la figura \ref{pic:Millman}, i dels títols de les taules \ref{taula:s_ieee_tt}, \ref{taula:IcsIcu},  \ref{taula:IcmIcu}
i \ref{taula:InIcw}.

Es millora la representació dels valors de la taula \ref{taula:SI-altres-acceptades}.
