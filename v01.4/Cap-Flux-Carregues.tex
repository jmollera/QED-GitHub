...
\begin{dinglist}{'121}
    ...
    xarxa, i per tant, totes les tensions de la xarxa hi estan referides. Al terra
    s'assigna el n\'{u}mero de nus 0, i per tant no forma part de la matriu d'admit\`{a}ncies de nus de la xarxa.
...
Nom\'{e}s hi pot haver un nus d'aquest tipus en tota la xarxa.
...
\section{Formulaci\'{o} del problema} \index{flux de c\`{a}rregues!formulaci\'{o} del problema}
...
\section{Control del flux de pot\`{e}ncia} \index{flux de c\`{a}rregues!control del flux de pot\`{e}ncia}
