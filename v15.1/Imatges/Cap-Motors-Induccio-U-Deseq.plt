...
set ytics 0.70,0.05,1.0 norangelimit textcolor rgb "black" 
...
set yrange [ 0.7000 : 1.000 ] noreverse nowriteback
...
set object rectangle from 0.0,0.7 to 5.0,1.0 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot "Cap-Motors-Induccio-U-Deseq.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000
#    EOF
