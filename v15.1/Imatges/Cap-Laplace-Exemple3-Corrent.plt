...
set xtics 0.00000,1,10.000 norangelimit textcolor rgb "black" 
set ytics border out scale 1,0.5 nomirror norotate  autojustify
set ytics -1.0000,1,4.0000 norangelimit textcolor rgb "black" 
...
set xrange [ 0.00000 : 10.000 ] noreverse nowriteback
set x2range [ 0.00000 : 10.000 ] noreverse nowriteback
set ylabel '$i\ped{L}(t)\, / \,\unit{A}$' 
set ylabel  font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  font "" textcolor lt -1 rotate by -270
set yrange [ -1.0000 : 4.0000 ] noreverse nowriteback
set y2range [ -1.0000 : 4.0000 ] noreverse nowriteback
set zlabel "" 
...
set output "Cap-Laplace-Exemple3-Corrent.tex"
set object rectangle from 0,-1 to 10,4 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot 5.2608*exp(-0.7375*x)*cos(0.39509*x-0.70697) linecolor rgb "red"  linewidth 6.000
#    EOF
