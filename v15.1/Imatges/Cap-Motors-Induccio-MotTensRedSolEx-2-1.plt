...
set ytics 0.04,0.01,0.09 norangelimit textcolor rgb "black" 
...
set y2tics 16.0,1.0,21.0 norangelimit textcolor rgb "black"
...
set yrange [ 0.04 : 0.09 ] noreverse nowriteback
set y2range [ 16.000 : 21.000 ] noreverse nowriteback
set zlabel "" 
...
set output "Cap-Motors-Induccio-MotTensRedSolEx-2-1.tex"
set object rectangle from 0.75,0.04 to 1,0.09 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedSolEx-Aux-2.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$s$', "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedSolEx-Aux-2.txt" using 1:3 with lines axes x1y2 linecolor rgb "sea-green"  linewidth 6.000 title '$I_1$'
#    EOF
