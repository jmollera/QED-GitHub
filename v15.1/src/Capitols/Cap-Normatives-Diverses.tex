...
\begin{list}{}
	...
	\item[$I$] Corrent que circula per la protecció 51. S'expressa en A.\footnote{\label{fn:I-Ip}De fet, només cal que $I$ i $I\ped{P}$ estiguin expressats en les mateixes unitats (per exemple en kA), perquè el seu quocient sigui adimensional.}
