\chapter*{Prefaci} \addcontentsline{toc}{chapter}{Prefaci}
   ...
   ordinador o d'una tauleta. També es pot imprimir per  llegir-lo com un llibre tradicional;  tenint al cap l'estalvi paper, el text
   té un format pensat per  ser imprès en paper DIN-A4,\index{DIN-A4} a dues cares.
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \textbf{Conjunts de nombres i intervals}. Exposa  els diversos conjunts de nombres i  intervals definits en la norma ISO 80000-2.
