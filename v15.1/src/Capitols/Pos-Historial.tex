...
\begin{itemize}
    \item En el mòdul \texttt{qed.utils}, s'ha canviat la implementació  de la classe \texttt{Complex}, sense modificar-ne cap característica externa.
    \item En el mòdul \texttt{qed.eng\_elc}, s'ha canviat la implementació  de les classes \texttt{IECcurve}, \texttt{IEEEcurve} i \texttt{Speed}, canviant-ne els noms dels elements interns de minúscula a majúscula, per emfatitzar que són constants. Això afecta a l'ús extern d'aquestes classes.
