...
\newcommand{\PotSistTresFils}{Càlcul de la potència en un sistema de tres fils}
...
\newcommand{\MetodeCalculPU}{Aplicació del mètode de càlcul en tant per u}
...
\newcommand{\MotorFaseOberta}{Motor alimentat amb una fase oberta}
...
% Títols dels exemples del Capítol Xarxes Elèctriques
...
\newcommand{\CurtcircuitXarxaSenzilla}{Curtcircuit --- Xarxa senzilla}
\newcommand{\CurtcircuitXarxaComplexa}{Curtcircuit --- Xarxa complexa}


% Títols dels exemples del Capítol Flux de Càrregues
