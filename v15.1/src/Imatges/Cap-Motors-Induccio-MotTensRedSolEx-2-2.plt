...
set ytics 0.82,0.02,0.9 norangelimit textcolor rgb "black" 
...
set yrange [ 0.820 : 0.900 ] noreverse nowriteback
...
set output "Cap-Motors-Induccio-MotTensRedSolEx-2-2.tex"
set object rectangle from 0.75,0.82 to 1,0.9 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedSolEx-Aux-2.txt" using 1:4 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$\cos\varphi$', "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedSolEx-Aux-2.txt" using 1:5 with lines axes x1y1 linecolor rgb "sea-green"  linewidth 6.000 title '$\eta$'
#    EOF
