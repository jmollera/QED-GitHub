...
set key title ""
set key inside right bottom vertical Left reverse enhanced box
...
set xtics 0.0,0.1,1.0 norangelimit textcolor rgb "black" 
set ytics border out scale 1,0.5 nomirror norotate  autojustify
set ytics 0.0,0.005,0.05 norangelimit textcolor rgb "black" 
...
set y2tics 0.0,2.0,20.0 norangelimit textcolor rgb "black"
...
set yrange [ 0.000 : 0.050 ] noreverse nowriteback
set y2range [ 0.000 : 20.000 ] noreverse nowriteback
set zlabel "" 
...
set output "Cap-Motors-Induccio-MotCarregaReduida-1.tex"
set object rectangle from 0,0 to 1,0.05 fillstyle solid fillcolor rgb "#FFFFF0" behind
set arrow from 0.5, second 9.743 to 0.5, second 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0.5}$}' at 0.485, 0.0075 center rotate by -270 front
set arrow from 0.5, second 9.743 to 1.0, second 9.743 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{9,7}{A}$}' at 0.85, 0.026 center front
set arrow from 0.5, 0.022581 to 0.0, 0.022581 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,0226}$}' at 0.15, 0.0235 center front
plot "../Python/Auxiliars/Cap-Motors-Induccio-MotCarregaReduida-Aux.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$s$', "../Python/Auxiliars/Cap-Motors-Induccio-MotCarregaReduida-Aux.txt" using 1:3 with lines axes x1y2 linecolor rgb "sea-green"  linewidth 6.000 title '$I_1$'
#    EOF
