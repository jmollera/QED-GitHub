...
set output "Ape-Trigonometria-sech.tex"
set object rectangle from -5.0,0.0 to 5.0,1.0 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot 1/cosh(x) linecolor rgb "red"  linewidth 6.000
#    EOF