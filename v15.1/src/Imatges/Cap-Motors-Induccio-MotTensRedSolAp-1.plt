...
set xtics 0.75,0.05,1.0 norangelimit textcolor rgb "black" 
set ytics border out scale 1,0.5 nomirror norotate  autojustify
set ytics 0.0,0.02,0.14 norangelimit textcolor rgb "black" 
...
set y2tics 16.0,2.0,30.0 norangelimit textcolor rgb "black"
...
set xlabel '$U_1/U\ped{n}$'
set xlabel  font "" textcolor lt -1 norotate
set x2label "" 
set x2label  font "" textcolor lt -1 norotate
set xrange [ 0.750 : 1.0000 ] noreverse nowriteback
set x2range [ 0.0000 : 5.0000 ] noreverse nowriteback
set ylabel  '$s$'
set ylabel  font "" textcolor lt -1 rotate by 0
set y2label  '$I_1\, / \,\unit{A}$'
set y2label  font "" textcolor lt -1 rotate by -270
set yrange [ 0.000 : 0.140 ] noreverse nowriteback
set y2range [ 16.000 : 30.000 ] noreverse nowriteback
set zlabel "" 
...
set output "Cap-Motors-Induccio-MotTensRedSolAp-1.tex"
set object rectangle from 0.75,0 to 1,0.14 fillstyle solid fillcolor rgb "#FFFFF0" behind
set arrow from 0.8, 0.0971 to 0.8, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,8}$}' at 0.797, 0.0125 center rotate by -270 front
set arrow from 0.8, 0.0971 to 0.75, 0.0971 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,0971}$}' at 0.766, 0.0935 left front
set arrow from 0.8, second 24.2 to 1.0, second 24.2 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{24,2}{A}$}' at 0.975, second 24.5 center front
plot "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedSolAp-Aux.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$s$', "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedSolAp-Aux.txt" using 1:3 with lines axes x1y2 linecolor rgb "sea-green"  linewidth 6.000 title '$I_1$'
#    EOF
