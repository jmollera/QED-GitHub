...
S'afegeix una nota a la taula \ref{tb:resit}, per indicar l'equivalència entre les unitats \si{ppm/\degreeCelsius}  i  \si{\micro\ohm/(\ohm.\kelvin)}.

Es millora el dibuix de l'exemple \ref{ex:control-v-cond}.
