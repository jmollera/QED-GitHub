...
set ylabel  '$P\ped{m}\, / \,\si{kW}, \quad P\, / \,\si{kW}, \quad Q\, / \,\si{kvar}, \quad S\, / \,\si{kVA}$'
...
set output "Cap-Motors-Induccio-Ex4-2.tex"
...
set label '{$\scriptstyle\SI{9052,8}{W}$}' at 150, 10.0 center norotate front
set arrow from 1425.0, 50.0 to 1425.0, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\SI{1425}{r/min}$}' at 1408, 25 center rotate by -270 front
plot "Cap-Motors-Induccio-Ex4-2.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$P\ped{m}$', "Cap-Motors-Induccio-Ex4-2.txt" using 1:3 with lines axes x1y1 linecolor rgb "sea-green"  linewidth 6.000 title '$P$', "Cap-Motors-Induccio-Ex4-2.txt" using 1:4 with lines axes x1y1 linecolor rgb "orange"  linewidth 6.000 title '$Q$',"Cap-Motors-Induccio-Ex4-2.txt" using 1:5 with lines axes x1y1 linecolor rgb "black"  linewidth 6.000 title '$S$'
#    EOF
