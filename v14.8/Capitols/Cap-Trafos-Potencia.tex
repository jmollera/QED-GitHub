...
Normalment, aquest valor és positiu, però quan la carrega connectada al secundari és fortament capacitiva, podem tenir  $|\cmplx{u}_2| > |\cmplx{u}_1|$ ---o sigui, tenim una caiguda de tensió negativa---; aquest fenomen  es coneix com l'efecte Ferranti.\index{efecte!Ferranti}
...
\begin{itemize}
   ...
   \item \textbf{Estrella--Triangle}. Són útils com a transformadors reductors al final de línia. També tenen un bon comportament  enfront de càrregues desequilibrades.
