...
\usepackage{textcomp}    % Símbol arrel quadrada
\usepackage{textgreek}   % Lletres gregues en mode text
...
\renewcommand{\labelitemii}{\faAngleRight} % Símbol pels items de 1n nivell
