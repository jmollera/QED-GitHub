...
\begin{list}{}
  ...
  hiperfins de l'estat fonamental de l'àtom de cesi-133. (1967).
   ...
   infinita, de secció transversal negligible, i situats a una
   distància l'un de l'altre d'un metre en el buit, produeix entre
...
\index{inductància} \index{temperatura!Celsius} \index{flux
lluminós} \index{iluminacio@iŀluminació} \index{activitat  d'un
radionúclid} \index{dosi absorbida}  \index{dosi equivalent}\index{activitat catalitica@activitat catalítica}
...
\begin{longtable}[h]{lll}
   ...
   concentració d'activitat catalítica &  \si{kat/m^3} & \si{m^{-3}.s^{-1}.mol}\\
    \bottomrule[1pt]
\end{longtable}
\index{viscositat dinamica@viscositat dinàmica}\index{moment d'una força}\index{tensió superficial}
\index{velocitat angular}\index{acceleracio angular@acceleració angular}\index{densitat de flux de calor}\index{entropia}\index{entropia especifica@entropia específica}\index{conductivitat termica@conductivitat tèrmica}\index{densitat d'energia}\index{intensitat de camp electric@intensitat de camp elèctric}\index{densitat de carrega electrica@densitat de càrrega elèctrica}\index{densitat de flux electric@densitat de flux elèctric}
...
\end{longtable}
\end{ThreePartTable}
\index{electró-volt}\index{unitat de massa atomica unificada@unitat de massa atòmica unificada}\index{unitat astronomica@unitat astronòmica}\index{dalton}\index{eV}\index{u}\index{ua}\index{Da}
...
Aquestes unitats i prefixes no pertanyen a l'SI, però han estat adoptats en la norma internacional CEI 60027-2 «Letter symbols to be used in electrical technology -- Part 2: Telecommunications and electronics».\index{CEI!60027-2}
...
\item No ha de deixar-se cap espai en blanc entre el símbol d'un prefixe i
...
\item El grup format pel símbol d'un prefixe i el símbol d'una unitat
...
\item Només es permet un prefixe davant d'una unitat.
...
conté un prefixe, ambdues parts s'han d'escriure juntes sense cap espai o element d'unió.
...
\item El separador decimal entre la part entera i decimal d'un valor por ser el punt o la coma. L'ús de l'un o l'altra varia segons el país. Si el valor està comprès entre -1 i +1, és obligatori escriure un zero davant del separador decimal.
...
\item Quan un valor té moltes xifres, les xifres poden dividir-se en grups de tres mitjançant un espai curt per tal de millorar-ne la legibilitat. No s'han d'utilitzar punts o comes per separar aquests grups de tres xifres.
...
\item Cal evitar l'utilització de «ppm» (parts per milió), «ppb» (parts per bilió), etc.
