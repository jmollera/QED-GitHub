...
\begin{picture}(7920.00,4800.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(143,2669){\rotatebox{-270}{\makebox(0,0){\strut{}$i\ped{dc}(t), i\ped{ac}(t), i(t) \, /\unit{kA}$}}}%
      \csname LTb\endcsname%
      ...
      \csname LTb\endcsname%
      \put(6856,4395){\makebox(0,0){\strut{}}}%
      \csname LTb\endcsname%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{Cap-Fonaments-RL-Serie-Curtcircuit-Exemple}}%
    \gplfronttext
  \end{picture}%
\endgroup
