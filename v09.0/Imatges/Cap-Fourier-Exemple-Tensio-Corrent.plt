...
set xtics 0.00000,2,16.000 norangelimit textcolor rgb "black" 
set ytics border out scale 1,0.5 nomirror norotate  autojustify
set ytics -30.0000,10,30.0000 norangelimit textcolor rgb "black" 
...
set y2tics -1.5000,0.5000,1.5000 norangelimit textcolor rgb "black"
...
set y2label '$i(t) \, / \unit{A}$' 
set y2label  font "" textcolor lt -1 rotate by -270
set yrange [ -30.0000 : 30.0000 ] noreverse nowriteback
set y2range [ -1.5000 : 1.5000 ] noreverse nowriteback
set zlabel "" 
...
z(n)=10+10*n*pi*{0,1}
plot 80.0/pi*(sum[k=1:30] sin((2*k-1)*0.2*pi*x)/(2*k-1)) axes x1y1 linecolor rgb "red" linewidth 6.000 title '$u(t)$', 80.0/pi*(sum[k=1:6] sin((2*k-1)*0.2*pi*x-arg(z(2*k-1)))/(2*k-1)/abs(z(2*k-1))) axes x1y2 linecolor rgb "sea-green"  linewidth 6.000 title '$i(t)$'
#    EOF
