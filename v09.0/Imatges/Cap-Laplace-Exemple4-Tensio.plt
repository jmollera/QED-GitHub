...
set xtics 0.00000,5,50.000 norangelimit textcolor rgb "black" 
set ytics border out scale 1,0.5 nomirror norotate  autojustify
set ytics -400.0000,100,400.0000 norangelimit textcolor rgb "black" 
...
set xrange [ 0.00000 : 50.000 ] noreverse nowriteback
set x2range [ 0.00000 : 50.000 ] noreverse nowriteback
set ylabel '$u\ped{C}(t) \, / \unit{V}$' offset -2,0
set ylabel  font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  font "" textcolor lt -1 rotate by -270
set yrange [ -400.0000 : 400.0000 ] noreverse nowriteback
...
ARGC = 0
ARG0 = ""
set terminal cairolatex pdf size 14cm,9cm
set output "Cap-Laplace-Exemple4-Tensio.tex"
plot 431.67*exp(-0.5*x)*cos(0.5*x+2.1613)+305.24*cos(0.31415*x-0.6642) linecolor rgb "red"  linewidth 6.000
#    EOF
