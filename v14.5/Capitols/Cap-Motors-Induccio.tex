...
\begin{ThreePartTable}
	\begin{TableNotes}
		\item[a] {\footnotesize També es fan servir els símbols no estàndard: «lb\ped{m}», «℔» i  «\#».}
	\end{TableNotes}
	\begin{longtable}[h]{llc}
...
\begin{list}{}
   {\setlength{\labelwidth}{12mm} \setlength{\leftmargin}{12mm} \setlength{\labelsep}{5mm}}
...
\begin{list}{}
   ...
   \item[$\cmplx{I}_1$] Corrent de fase de l'estator; varia en funció del lliscament $s$.
   \item[$R_1$] Resistència per fase de l'estator.
   \item[$X_1$] Reactància de dispersió per fase de l'estator.
   \item[$\cmplx{I}_0$] Corrent d'excitació; varia en funció del lliscament $s$.
   \item[$R\ped{Fe}$] Resistència de pèrdues del nucli.
   \item[$X\ped{m}$] Reactància de magnetització.
   \item[$\cmplx{I}_2$] Corrent de fase del rotor, vista per l'estator; varia en funció del lliscament $s$.
...
\begin{exemple}[\TensDeseqMotor{} \hyperlink{exemple:TensDeseqMotor}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:TensDeseqMotor}
	...
	\frac{\complexqty{379,41:0}{V}}{\sqrt{3}\angle\ang{30}} =
	\complexqty{219,05:-30}{V} \\[1ex]
	\cmplx{U}\ped{AN,2} &=
	\frac{\cmplx{U}\ped{AB,2}}{\sqrt{3}\angle{\ang{-30}}} =
	\frac{\complexqty{19,59:0}{V}}{\sqrt{3}\angle{\ang{-30}}} =
