...
Es milloren algunes figures i equacions de les seccions \ref{sec:pot-monof} i \ref{sec:pot-trif}.

Es millora la figura \ref{pic:Comp_sim}.

A l'apèndix \ref{sec:SI}, es modifiquen les unitats de la constant de Planck, passant de \unit{J/Hz} a \unit{J.s} ---encara que són equivalents---, ja que aquestes són les que apareixen en les publicacions  del \textit{Bureau 	International des Poids et Mesures}.
