...
\section{Numeraci\'{o} \textsf{ANSI} de dispositius el\`{e}ctrics} \index{numeraci\'{o} ANSI de dispositius el\`{e}ctrics}
\index{ANSI!C37.2}
...
codificar tamb\'{e} la protecci\'{o} proporcionada per les envoltants contra
...
creixents d'energia d'impacte que pot suportar l'envoltant.


\section{Classes \textsf{NEMA} d'a\"{\i}llaments t\`{e}rmics en motors}
...
motor.\index{temperatura!en el punt m\'{e}s calent} \pagebreak
