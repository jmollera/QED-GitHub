...
try:
    with open("Cap-Motors-Induccio-MotTensRedSolEx-Aux-1.txt", "w", encoding="utf8") as fh:
...
try:
    with open("Cap-Motors-Induccio-MotTensRedSolEx-Aux-2.txt", "w", encoding="utf8") as fh:
