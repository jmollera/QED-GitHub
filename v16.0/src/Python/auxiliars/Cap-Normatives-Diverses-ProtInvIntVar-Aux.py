...
Iat = Ia(t)  # ampere
try:
    with open("Cap-Normatives-Diverses-ProtInvIntVar-Aux-1.txt", "w", encoding="utf8") as fh:
...
t51I = t51(I)  # segons
try:
    with open("Cap-Normatives-Diverses-ProtInvIntVar-Aux-2.txt", "w", encoding="utf8") as fh:
