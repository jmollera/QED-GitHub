...
i_1, u_1 = i_u(t[t <= t_1], 0, E_bat, R_bat + R)
I_1 = i_1[-1]

i_2, u_2 = i_u(t[(t > t_1) & (t <= t_2)] - t_1, I_1, 0, R)
I_2 = i_2[-1]

i_3, u_3 = i_u(t[t > t_2] - t_2, I_2, E_bat, R_bat + R)
...
ax1.set_yticks(yticks1, [f'{tick:.0f}' for tick in yticks1])
ax1.grid()
