...
mot_100_start_up = motor.start_up(T_load, J, U_1_100)
print(f's,100% = {s_100_fun:.4f}')
print(f'n_m,100% = {motor.convert(s_100_fun, Speed.slip_to_n) :.1f} r/min')
...
print(f't_arr,100% = {mot_100_start_up.t_start:.1f} s\n')

s_80_fun = motor.s_match(T_load, U_1_80)
mot_80_fun = motor.run(s_80_fun, U_1_80)
mot_80_arr = motor.run(1, U_1_80)
mot_80_start_up = motor.start_up(T_load, J, U_1_80)
print(f's,80% = {s_80_fun:.4f}')
print(f'n_m,80% = {motor.convert(s_80_fun, Speed.slip_to_n) :.1f} r/min')
...
print(f't_arr,80% = {mot_80_start_up.t_start:.1f} s\n')
...
s_100_t_arr = mot_100_start_up.s_at_time(t_arr)
mot_100_t_arr = motor.run(s_100_t_arr, U_1_100)
T_load_100_t_arr = T_load(s_100_t_arr)
s_80_t_arr = mot_80_start_up.s_at_time(t_arr)
