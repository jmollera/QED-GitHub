...
set xtics -5.0, 1.0, 5.0 norangelimit textcolor rgb "black" 
set ytics border out scale 1,0.5 nomirror norotate  autojustify
set ytics -80.0, 20.0, 80.0 norangelimit textcolor rgb "black" 
...
set xrange [ -5.0 : 5.0] noreverse nowriteback
set x2range [ 0.00000 : 50.000 ] noreverse nowriteback
set ylabel '$\sinh z$' 
set ylabel  font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  font "" textcolor lt -1 rotate by -270
set yrange [ -80.0 : 80.0 ] noreverse nowriteback
...
set output "Ape-Trigonometria-sinh.tex"
set object rectangle from -5.0,-80.0 to 5.0,80.0 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot sinh(x) linecolor rgb "red"  linewidth 6.000
#    EOF