...
set key noinvert samplen 2 spacing 1.5 width 0.5 height 0.5 
...
set output "Cap-Motors-Induccio-CaractMotor-1.tex"
set object rectangle from 0,0 to 1500,150 fillstyle solid fillcolor rgb "#FFFFF0" behind
set arrow from 1425.0, 60.70 to 0.0, 60.7 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{60,7}{N.m}$}' at 300, 63.7 center norotate front
set arrow from 1157.62, 132.70 to 0.0, 132.7 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{132,7}{N.m}$}' at 300, 135.7 center norotate front
set arrow from 1425.0, 60.70 to 1425.0, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1425}{r/min}$}' at 1408, 18 center rotate by -270 front
set arrow from 1157.62, 132.70 to 1157.62, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1157,6}{r/min}$}' at 1140, 20 center rotate by -270 front
set arrow from 1275, second 17.67 to 1500, second 17.67 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{17,7}{A}$}' at 1325, second 19 center front
plot "../Python/Auxiliars/Cap-Motors-Induccio-CaractMotor-Aux.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$T\ped{m}$', "../Python/Auxiliars/Cap-Motors-Induccio-CaractMotor-Aux.txt" using 1:3 with lines axes x1y2 linecolor rgb "sea-green"  linewidth 6.000 title '$I_1$'
#    EOF
