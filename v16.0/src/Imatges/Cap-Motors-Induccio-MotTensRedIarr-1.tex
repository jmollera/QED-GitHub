...
\begin{picture}(9340.00,5660.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \csname LTb\endcsname%%
      \put(7828,1345){\rotatebox{-270}{\makebox(0,0){$\scriptstyle\qty{1427,3}{r/min}$}}}%
      \csname LTb\endcsname%%
      \put(1668,4298){\makebox(0,0){$\scriptstyle\qty{117,5}{N.m}$}}%
      \csname LTb\endcsname%%
      \put(6573,1407){\rotatebox{-270}{\makebox(0,0){$\scriptstyle\qty{1170,5}{r/min}$}}}%
      \csname LTb\endcsname%%
      \put(7427,1904){\makebox(0,0){$\scriptstyle\qty{16,9}{A}$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{Cap-Motors-Induccio-MotTensRedIarr-1}}%
    \gplfronttext
  \end{picture}%
\endgroup
