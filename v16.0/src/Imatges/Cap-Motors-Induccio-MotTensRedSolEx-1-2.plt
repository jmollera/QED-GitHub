...
set arrow from 1430.8, 56.6 to 1430.8, 0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1430,8}{r/min}$}' at 1427, 15 center rotate by -270 front
set arrow from 1388.0, 53.4 to 1388.0, 0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1388,0,5}{r/min}$}' at 1383.7, 15 center rotate by -270 front
set arrow from 1430.8, 56.6 to 1200, 56.6 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{56,6}{N.m}$}' at 1230, 58 center front
set arrow from 1388.0, 53.4 to 1200, 53.4 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{53,4}{N.m}$}' at 1230, 51.5 center front
set arrow from 1430.8, second 16.6 to 1500, second 16.6 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{16,6}{A}$}' at 1480, second 17.3 center front
set arrow from 1388.0, second 19.6 to 1500, second 19.6 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
