...
set output "Ape-Trigonometria-csc.tex"
set object rectangle from -2*pi,-5.0 to 2*pi,5.0 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot 1/sin(x) linecolor rgb "red"  linewidth 6.000
#    EOF