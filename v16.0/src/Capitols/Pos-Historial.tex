...
\begin{itemize}
    ...
    \item En el mòdul \texttt{qed.eng\_elc} s'ha modificat la implementació  de la classes \texttt{Motor3ph}, eliminat els mètodes \texttt{t\_start} i \texttt{s\_start\_up}, i creant  el nou mètode \texttt{start\_up}, que torna alhora els resultats que tornaven per separat els dos mètodes eliminats. Això afecta a l'ús extern d'aquesta classe.
    \item Ha calgut modificar el programa \texttt{Exemple-12-3.py}, afegint el paràmetre \texttt{tap\_changer\_type ='Ratio'} a la funció \texttt{create\_transformer\_from\_parameters}. Això és degut al canvi de versió de la llibreria \texttt{pandapower}.
\end{itemize}
