...
S'actualitza l'apèndix  B amb els nous valors recomanats de les constants físiques  l'any 2022 pel \textit{Committee on Data for Science and Technology} (CODATA). S'han afegit constants a la taula \ref{taula:Const-Fis}.
...
\begin{itemize}
    ...
    \item En el mòdul \texttt{qed.eng\_elc} s'ha modificat la implementació  de les classes \texttt{IECcurve}, \texttt{IEEEcurve} i \texttt{Speed}, canviant-ne els noms dels elements interns de minúscula a majúscula, per emfatitzar que són constants. Això afecta a l'ús extern d'aquestes classes.
    ...
    \item En el mòdul \texttt{qed.eng\_elc} s'ha modificat la implementació  de la classes \texttt{Motor3ph}, eliminat els mètodes \texttt{t\_start} i \texttt{s\_start\_up}, i creant en el nou mètode \texttt{start\_up}, que torna alhora els resultats que tornaven per separat els dos mètodes eliminats. Això afecta a l'ús extern d'aquesta classe.
