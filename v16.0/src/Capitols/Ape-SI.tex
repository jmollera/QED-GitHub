...
International des Poids et Mesures} (BIPM). S'ha utilitzat la publicació més recent, corresponent a la 9a edició de març de 2019, revisada el desembre de  2022 amb l'addició dels nous prefixos per als factors $10^{27}$,  $10^{30}$,  $10^{-27}$ i  $10^{-30}$, i l'agost de 2024 amb la millora de la descripció dels angles i de les magnituds unitàries. Podeu trobar més informació a les adreces: \href{https://www.bipm.org/en/home/}{https:/\!\!/www.bipm.org/en/home} i \href{https://www.bipm.org/en/publications/si-brochure/}{https:/\!\!/www.bipm.org/en/publications/si-brochure}. \index{BIPM}
...
Les unitats fonamentals (vegeu la taula \vref{taula:SI-fonamentals}) i les unitats derivades amb noms i símbols propis (vegeu la taula \vref{taula:SI-derivades}) poden combinar-se entre si per crear noves unitats derivades.
