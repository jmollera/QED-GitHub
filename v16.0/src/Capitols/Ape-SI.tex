...
Internacional d'unitats (SI), el qual està publicat pel  \textit{Bureau
...
Les 7 unitats fonamentals (vegeu la taula \vref{taula:SI-fonamentals}) i les 22 unitats derivades amb noms i símbols propis (vegeu la taula \vref{taula:SI-derivades}) poden combinar-se entre si per crear noves unitats derivades.
...
Es dona, no obstant això, en la taula \vref{taula:SI-altres-NIST} quatre unitats fora de l'SI acceptades addicionalment pel NIST (\textit{Special Publication 811: Guide for the Use of the International System of Units (SI)}), ja que s'han utilitzat tradicionalment als Estats Units d'Amèrica; aquest organisme desaconsella però continuar usant-les, i recomana l'ús de les unitats equivalents de l'SI.\index{NIST}
...
\textcolor{Green}\faCheckSquare{} \textit{l} = \qty{1}{m}

\textcolor{Red}\faTimesCircle{} \textit{l} = 1 \textit{m}
...
\textcolor{Green}\faCheckSquare{} \qty{3e-6}{quilograms} = 3 miŀligrams

\textcolor{Red}\faTimesCircle{} \qty{3e-6}{kg} = \qty{3}{\micro kg}

\textcolor{Red}\faTimesCircle{} \qty{3e-6}{quilograms} = 3 microquilograms
...
\textcolor{Green}\faCheckSquare{} \qty{1200}{MW} són 1200 megawatts

\textcolor{Red}\faTimesCircle{} \qty{1200}{MW} són 1200 Megawatts

\textcolor{Green}\faCheckSquare{} \qty{12}{GHz} són 12 gigahertzs

\textcolor{Red}\faTimesCircle{} \qty{12}{GHz}  són 12 Gigahertzs
