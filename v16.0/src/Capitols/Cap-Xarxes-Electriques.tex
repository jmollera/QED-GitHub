...
\begin{alignat}{3}
    \mcmplx{V}\ped{N}^{\text{F}} &=  \mcmplx{V}\ped{N} +  \mcmplx{V}\ped{N}' &&= \mcmplx{Z}\ped{N} \cdot \mcmplx{J}\ped{N} + \mcmplx{Z}\ped{N} \cdot \mcmplx{J}\ped{N}' &&= \mcmplx{Z}\ped{N} \cdot (\mcmplx{J}\ped{N} + \mcmplx{J}\ped{N}') \label{eq:VN-F} \\[0.5em]
...
\begin{exemple}[\CurtcircuitXarxaComplexa{} \hyperlink{exemple:CurtcircuitXarxaComplexa}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:CurtcircuitXarxaComplexa}
    ...
    A partir de $\mcmplx{J}\ped{N}'$ i dels valors ja coneguts de $\mcmplx{J}\ped{N}$, $\mcmplx{Z}\ped{N}$, $\mcmplx{Y}\ped{B}$, $\mcmplx{J}\ped{B}$ i $\boldsymbol{A}$, farem servir les equacions \eqref{eq:VN-F}, \eqref{eq:UB-F} i \eqref{eq:IB-F} per calcular $\mcmplx{V}\ped{N}^{\text{F}}$, $\mcmplx{U}\ped{B}^{\text{F}}$ i $\mcmplx{I}\ped{B}^{\text{F}}$:
