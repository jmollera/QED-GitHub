...
Els valors per defecte de la resta de paràmetres són: $C=\qty{0}{s}$, $B=\qty{0}{s}$, i $T=1$; els fabricants de relés de protecció poden assignar  rangs de valors a aquests paràmetres per obtenir diverses famílies de corbes.\index{CEI!60255-151} En la taula \vref{taula:CEI-51} es poden veure els valors de $k$ i $\alpha$, i els noms que es donen a les corbes d'actuació.
