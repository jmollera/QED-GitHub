...
$\alpha=\omega t$, $\alpha_0=\omega t_0$, i $\diff\alpha=\omega\diff t$, on $\alpha$ està expressat  en radian.
...
Finalment, insertant $P$ i $S$ en l'equació \eqref{eq:p-instantania-1},  tenim:
\begin{equation}
