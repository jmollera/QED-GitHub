...
set grid linecolor "black" linetype 1 linewidth 1.00 
set raxis
set style parallel front  lt black linewidth 2.000 dashtype solid
set key title ""
set key inside center bottom vertical Left reverse enhanced box
...
set xtics 0.0,100.0,1500.0 norangelimit textcolor rgb "black" 
...
ARGC = 0
ARG0 = ""
set terminal cairolatex pdf size 17cm,10cm
set output "Cap-Motors-Induccio-Ex4.tex"
...
set label '{$\scriptstyle\SI{1425}{r/min}$}' at 1408, 20 center rotate by -270 front
set arrow from 1157.62, 132.70 to 1157.62, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\SI{1157,6}{r/min}$}' at 1140, 22 center rotate by -270 front
plot "Cap-Motors-Induccio-Ex4.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$T\ped{m}$', "Cap-Motors-Induccio-Ex4.txt" using 1:3 with lines axes x1y2 linecolor rgb "sea-green"  linewidth 6.000 title '$I_1$'
#    EOF
