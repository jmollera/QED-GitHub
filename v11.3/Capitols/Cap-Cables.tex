\addtocontents{toc}{\protect\newpage} %force a page break in ToC
...
D'aquesta taula es pot extreure la següent relació aproximada entre una secció $S$ expressada en $\si{mm^2}$ i la mateixa secció $S$ expressada en $\si{kcmil}$:
\begin{equation}
...
\addcontentsxms{Secció en \si{mm^2} d'un conductor AWG}
...
\addcontentsxms{Número AWG corresponent a una secció en \si{mm^2}}
