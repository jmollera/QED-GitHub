...
són: \qtylist{1;2;5}{A}, essent aquest darrer valor el
...
\begin{exemple}[Determinació de les característiques d'un transformador de corrent]
	\addcontentsxms{Determinació de les característiques d'un transformador de corrent}
...
Quan els secundaris tenen preses múltiples, els terminals s'identifiquen com X\ped{1}, X\ped{2}, X\ped{3}, etc.{} (o Y\ped{1}, Y\ped{2}, Y\ped{3}, etc.{}, Z\ped{1}, Z\ped{2}, Z\ped{3}, etc.{}). Quan el terminal X\ped{1} no s'utilitza, el terminal utilitzat amb el menor número és l'homòleg del terminal primari; per exemple, un transformador amb un primari H\ped{1}, H\ped{2}, i un secundari  X\ped{1}, X\ped{2}, X\ped{3}, X\ped{4} i X\ped{5}, on els terminals secundaris utilitzats són els X\ped{2} i  X\ped{4}, els terminals homòlegs són H\ped{1} i X\ped{2}.
...
\begin{exemple}[Equivalència entre transformadors IEEE i CEI]
	\addcontentsxms{Equivalència entre transformadors IEEE i CEI}
...
\begin{exemple}[Connexió d'un wattímetre a una instaŀlació existent]
	\addcontentsxms{Connexió d'un wattímetre a una instaŀlació existent}
