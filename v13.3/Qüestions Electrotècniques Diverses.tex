...
\usepackage{fontawesome} % Dingbats de correcte, incorrecte, interrogant, admiració, quadrat, items i carta
...
%\newcommand\kwst[1]{{\color[rgb]{0.68,0.31,0.68}\bfseries{#1}}} % HP PRIME
\lstset{
	xleftmargin=7mm,
	xrightmargin=7mm,
...
pdftitle={Qüestions Electrotècniques Diverses}, pdfauthor={Josep
	Mollera}, pdfcreator={Josep Mollera}, pdfsubject={Electrotècnia}, pdfkeywords={Electrotècnia, Sistemes Elèctrics de Potència}, pdflang={Catalan}, pdfview={FitH},pdfstartview={Fit}, pdfpagelabels=true,colorlinks=true, linkcolor=black, plainpages=false]{hyperref}

%\includeonly{Capitols/Cap-Transformada-Laplace}
\begin{document}
   \frontmatter
