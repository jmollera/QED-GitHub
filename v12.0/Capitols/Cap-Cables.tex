...
\index{AWG (\guillemotleft American Wire Gauge\guillemotright)!conversió a \si{mm^2}} Es donen a continuació les equacions per passar directament d'un número AWG a la seva secció equivalent $S$  expressada en \si{mm^2}, i al seu diàmetre equivalent $d$  expressat en \si{mm}.
\begin{align}
