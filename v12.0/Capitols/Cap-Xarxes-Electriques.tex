...
\begin{exemple}[Aplicació del mètode dels nusos -- Xarxa amb acoblaments magnètics]\label{ex:metode-nusos}
	\addcontentsxms{Aplicació del mètode dels nusos -- Xarxa amb acoblaments magnètics}
    ...
    En aquest cas farem servir la funció \funsfbs{RREF} «Reduced-Row Echelon Form» per resoldre el nostre sistema de quatre equacions lineals amb coeficients complexos; els passos a seguir són els següents:
    ...
    \begin{dingautolist}{'312}
         ...
         \item Finalment, premem la tecla \includegraphics{HPPrime-Enter.pdf} i la calculadora ens dona una matriu que conté la solució; les quatre primeres columnes formen una matriu identitat, la qual cosa indica que el sistema té solució i que és única, i la cinquena columna és la  solució buscada.
...
\begin{exemple}[Aplicació del mètode dels nusos -- Xarxa sense acoblaments magnètics]
	\addcontentsxms{Aplicació del mètode dels nusos -- Xarxa sense acoblaments magnètics}
...
\begin{exemple}[Impedància Thévenin entre dos nusos d'una xarxa]
	\addcontentsxms{Impedància Thévenin entre dos nusos d'una xarxa}
