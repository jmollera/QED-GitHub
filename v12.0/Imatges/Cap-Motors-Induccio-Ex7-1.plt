...
set output "Cap-Motors-Induccio-Ex7-1.tex"
...
set label '{$\scriptstyle\SI{24,2}{A}$}' at 0.975, second 24.5 center front
plot "Cap-Motors-Induccio-Ex7.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$s$', "Cap-Motors-Induccio-Ex7.txt" using 1:3 with lines axes x1y2 linecolor rgb "sea-green"  linewidth 6.000 title '$I_1$'
#    EOF
