...
set output "Cap-Motors-Induccio-Ex8-2-1.tex"
set object rectangle from 0.75,0.04 to 1,0.09 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot "Cap-Motors-Induccio-Ex8-2.txt" using 1:2 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$s$', "Cap-Motors-Induccio-Ex8-2.txt" using 1:3 with lines axes x1y2 linecolor rgb "sea-green"  linewidth 6.000 title '$I_1$'
#    EOF
