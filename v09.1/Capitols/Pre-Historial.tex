...
Es crea la Figura \ref{pic:val-mitja}, on s'hi representen els paràmetres d'una funció periòdica qualsevol.

Es modifica en la secció \ref{sec:calcul-comp-sim} la funció \texttt{\textbf{Triangle→Fasors}}, fent-la més simple.

Es milloren les equacions \eqref{eq:awg_mm2} i \eqref{eq:awg_mm}.

Es creen les equacions \eqref{eq:mm2_awg} i \eqref{eq:mm_awg}, i un exemple de com utilitzar-les.

Es coloreja la Taula \ref{taula:func-trig-signes}, per tal de distingir millor els valors positius dels negatius. 