...
\index{AWG (\guillemotleft American Wire Gauge\guillemotright)!conversió a\unit{mm^2}} Es donen a continuació les equacions per passar directament d'un número AWG a la seva secció $S$ equivalent expressada en\unit{mm^2}, i al seu diàmetre $d$ equivalent expressat en\unit{mm}.
\begin{align}
   ...
   \frac{\num{25,4} \times 460}{10^3 \times 92^{3/39} \times 92^{\text{AWG}/39}} =
...
\begin{exemple}[Número AWG corresponent a una secció en\unit{mm^2}]
