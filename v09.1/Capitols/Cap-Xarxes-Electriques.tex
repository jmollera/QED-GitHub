...
\begin{exemple}[Aplicació del mètode dels nusos -- Xarxa amb acoblaments magnètics]\label{ex:metode-nusos}
   ...
   \]
    ...
    En aquest exemple utilitzarem la funció \texttt{\textbf{RREF}} «Reduced-Row Echelon Form» per resoldre el nostre sistema de quatre equacions lineals amb coeficients complexes; els passos a seguir són els següents:
