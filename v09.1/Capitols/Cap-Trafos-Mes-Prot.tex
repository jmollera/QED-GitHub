...
En aquesta expressió, els errors $\epsilon\ped{c}$ i $\epsilon\ped{r}$  estan expressats en \%, i l'error $\epsilon\ped{\phiup}$ està expressat en crad.
...
\begin{exemple}[Determinació de les característiques d'un transformador de corrent]
    ...
    \begin{description}
        ...
        $I\ped{n,rel\acute{e}}=5\unit{A}$, $I\ped{m\acute{a}x,rel\acute{e}}=
        100 I\ped{n,rel\acute{e}}$
        \item [\hspace{5mm}Convertidor:] $S\ped{n,conv}=1\unit{VA}$,
        $I\ped{n,conv}=5\unit{A}$, $I\ped{m\grave{a}x,conv}=
        80 I\ped{n,conv}$
