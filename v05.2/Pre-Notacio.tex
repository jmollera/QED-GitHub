...
\setlength{\labelsep}{5mm}}
    ...
    $Z=+\sqrt{A^2+B^2},\quad\psi=\arctan{\dfrac{B}{A}},\quad
    A=Z\cos\psi,\quad B=Z\sin\psi$
...
\setlength{\labelsep}{5mm}}
    ...
    \item[$\omega$] Velocitat angular de la funci\'{o} sinuso\"{\i}dal; $\omega = 2 \piup f = 2 \piup\,/T$.
    ...
    \item[$\psi$] Angle inicial de la funci\'{o} sinuso\"{\i}dal; $\psi=\omega t_0$ (vegeu el gr\`{a}fic a continuaci\'{o}). $\psi$ \'{e}s positiu quan es mesura des de l'origen cap a l'esquerra, fins a trobar el primer valor m\`{a}xim de la funci\'{o} sinuso\"{\i}dal, i \'{e}s negatiu quan es mesura des de l'origen cap a la dreta, fins a trobar tamb\'{e} el primer valor m\`{a}xim de la funci\'{o} sinuso\"{\i}dal.
