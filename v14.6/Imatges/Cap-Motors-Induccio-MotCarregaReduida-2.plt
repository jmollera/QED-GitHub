...
set xtics 0.0,0.1,1.0 norangelimit textcolor rgb "blackz" 
...
set output "Cap-Motors-Induccio-MotCarregaReduida-2.tex"
set object rectangle from 0,0 to 1,1 fillstyle solid fillcolor rgb "#FFFFF0" behind
set arrow from 0.5, 0.882317 to 0.5,  0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,5}$}' at 0.485, 0.15 center rotate by -270 front
set arrow from 0.5,  0.882317 to 0.0,  0.882317 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,8823}$}' at 0.13, 0.86 center front
set arrow from 0.5, 0.800024 to 0.0, 0.800024 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,8000}$}' at 0.13, 0.815 center front
plot "../Python/Auxiliars/Cap-Motors-Induccio-MotCarregaReduida-Aux.txt" using 1:4 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$\cos\varphi$', "../Python/Auxiliars/Cap-Motors-Induccio-MotCarregaReduida-Aux.txt" using 1:5 with lines axes x1y1 linecolor rgb "sea-green"  linewidth 6.000 title '$\eta$'
#    EOF
