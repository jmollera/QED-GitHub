...
set key at 1375, 218.5  Left reverse  box
...
set ytics 205.0,1.0,220.0 norangelimit textcolor rgb "black" 
...
set ylabel  '$U_1\, / \,\unit{V}, \quad U\ped{1,sist}\, / \,\unit{V}$'
set ylabel  font "" textcolor lt -1 rotate by -270
set y2label  ''
set y2label  font "" textcolor lt -1 rotate by -270
set yrange [ 205.000 : 220.000 ] noreverse nowriteback
...
set output "Cap-Motors-Induccio-MotTensRedIarr-2.tex"
set object rectangle from 0,205 to 1500,220 fillstyle solid fillcolor rgb "#FFFFF0" behind
set arrow from 1427.3, 214.305 to 0.0, 214.305 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{214,305}{V}$}' at 150, 214.6 center norotate front
set arrow from 1427.3, 214.305 to 1427.3, 205.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1427,3}{r/min}$}' at 1412, 208 center rotate by -270 front
plot "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedIarr-Aux.txt" using 1:5 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$U_1$', 219.393 with lines axes x1y1 linecolor rgb "sea-green" linewidth 6.000 title '$U\ped{1,sist}$'
#    EOF
