...
\section{Solució de funcions no lineals}\index{funcions!no lineals}\label{sec:func-no-lin}
...
\subsection{Mètode de Newton}\label{sec:metode-newton}\index{funcions!no lineals!mètode de Newton}
...
\section{Solució de sistemes de funcions  no lineals}\index{funcions!sistemes no lineals}\label{sec:sist-func-no-lin}

Es descriu en aquesta secció el mètode de Newton per resoldre sistemes de funcions no lineals, és a dir, es vol resoldre el següent sistema de $n$ equacions no lineals amb $n$ variables:
\begin{align}
