...
La fórmula de Mollweide, la qual lliga els tres costats amb els tres angles interiors d'un triangle, ens dona les relacions següents:\index{formula@fórmula!de Mollweide}
\begin{subequations}
\begin{align}
...
\index{formula@fórmula!d'Heron}\index{area@àrea}\index{A@$\mathscr{A}$}
\begin{align}
