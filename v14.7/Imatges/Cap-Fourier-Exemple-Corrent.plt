...
set ytics -1.0000,0.2500,1.0000 norangelimit textcolor rgb "black" 
...
set ylabel '$i(t)\, / \,\unit{A}$' offset -0.5,0 
set ylabel  font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  font "" textcolor lt -1 rotate by -270
set yrange [ -1.0000 : 1.0000 ] noreverse nowriteback
set y2range [ -1.0000 : 1.0000 ] noreverse nowriteback
set zlabel "" 
...
set output "Cap-Fourier-Exemple-Corrent.tex"
set object rectangle from 0,-1 to 16,1 fillstyle solid fillcolor rgb "#FFFFF0" behind
z(n)=10+10*n*pi*{0,1}
plot  80.0/pi*(sum[k=1:6] sin((2*k-1)*0.2*pi*x-arg(z(2*k-1)))/(2*k-1)/abs(z(2*k-1))) linecolor rgb "red"  linewidth 6.000
#    EOF
