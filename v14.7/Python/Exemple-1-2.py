...
circuit = ee.Network()
circuit.add(ee.Branch(ee.VoltageSource(E=U_AN, Z=R_A), from_to=(1, 0), branch=1))
circuit.add(ee.Branch(ee.VoltageSource(E=U_BN, Z=R_B), from_to=(1, 0), branch=2))
circuit.add(ee.Branch(ee.VoltageSource(E=U_CN, Z=R_C), from_to=(1, 0), branch=3))
circuit.add(ee.Branch(ee.Impedance(Z=R_N), from_to=(0, 1), branch=4))
circuit.solve()
