...
S'amplia la secci\'{o} \ref{sec:seccio_pu} dedicada als c\`{a}lculs en p.u.
...
Es revisa l'ap\`{e}ndix C utilitzant les publicacions de l'any 2010 del {"<}Committee on Data for Science and Technology{">} (\textsf{CODATA}).\index{CODATA}
