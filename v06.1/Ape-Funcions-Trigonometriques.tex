...
\caption{Lleis trigonom\`{e}triques dels triangles} \label{pic:llei-s-c-t}
\end{figure}
...
La f\'{o}rmula de Mollweide ens d\'{o}na les relacions seg\"{u}ents:\index{f\'{o}rmula de Mollweide}
\begin{subequations}
\begin{align}
