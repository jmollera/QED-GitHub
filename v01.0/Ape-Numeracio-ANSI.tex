...
\item[\textbf{20}] \index{v\`{a}lvula} \textbf{V\`{a}lvula}. S'assigna aquest n\'{u}mero a una v\`{a}lvula
...
\index{dispositiu!de tensi\'{o} de polaritzaci\'{o}}
...
\item[\textbf{57}] \index{dispositiu!de curt circuit o de posta a terra}
...
\item[\textbf{60}] \index{rel\`{e}!d'equi{\l.l}ibri de tensi\'{o} o corrent} \textbf{Rel\`{e} d'equi{\l.l}ibri de
...
\item[\textbf{70}] \index{re\`{o}stat} \textbf{Re\`{o}stat}. \'{E}s un dispositiu utilitzat per
...
\item[\textbf{93}] \index{contactor!de canvi de camp} \textbf{Contactor de canvi de camp}. \'{E}s el
