...
La codificaci\'{o} en colors del valor \`{o}hmic de les resist\`{e}ncies consisteix en tres o quatre
bandes de color, m\'{e}s una banda de color addicional, una mica separada, per codificar la
toler\`{a}ncia.
...
Fa temps existien tamb\'{e} resist\`{e}ncies de toler\`{a}ncia $\pm50\unit{\%}$, per\`{o} avui en dia ja
no se'n fabriquen.
...
\begin{table}[htb]
   \caption{Valors \`{o}hmics est\`{a}ndard de les resist\`{e}ncies de toler\`{a}ncia $\leqslant\pm0{,}5\unit{\%}$}
   \[ \begin{array}{cccccccccccc}
   \toprule[1pt]
