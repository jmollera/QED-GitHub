...
Fa temps existien tamb\'{e} resist\`{e}ncies de toler\`{a}ncia $\SI{\pm 50}{\%}$,
...
\begin{exemple}[Valors de resist\`{e}ncies de tres i quatre bandes]
...
\begin{center}
   \captionof{table}{Valors \`{o}hmics est\`{a}ndard de les resist\`{e}ncies de toler\`{a}ncia $\SI{\pm 20}{\%}$}
   \[ \begin{array}{cccccc}
   \toprule[1pt]
...
\begin{center}
   \captionof{table}{Valors \`{o}hmics est\`{a}ndard de les resist\`{e}ncies de toler\`{a}ncia $\SI{\pm 10}{\%}$}
...
\pagebreak
\begin{center}
   \captionof{table}{Valors \`{o}hmics est\`{a}ndard de les resist\`{e}ncies de toler\`{a}ncia $\SI{\pm 5}{\%}$}
   \[ \begin{array}{cccccccccccc}
   \toprule[1pt]
...
\begin{center}
   \captionof{table}{Valors \`{o}hmics est\`{a}ndard de les resist\`{e}ncies de toler\`{a}ncia $\SI{\pm 2}{\%}$}
   \[ \begin{array}{cccccccccccc}
   \toprule[1pt]
...
\begin{center}
   \captionof{table}{Valors \`{o}hmics est\`{a}ndard de les resist\`{e}ncies de toler\`{a}ncia $\SI{\pm 1}{\%}$}
   \[ \begin{array}{cccccccccccc}
   \toprule[1pt]
...
\begin{center}
   \captionof{table}{Valors \`{o}hmics est\`{a}ndard de les resist\`{e}ncies de toler\`{a}ncia $\leq\SI{\pm 0,5}{\%}$}
   \[ \begin{array}{cccccccccccc}
   \toprule[1pt]
...
\section{Pot\`{e}ncia} \index{resist\`{e}ncies!pot\`{e}ncia}\label{sec:resist-pot}

Les resist\`{e}ncies tenen, a m\'{e}s del valor \`{o}hmic, un altre par\`{a}metre assignat: la pot\`{e}ncia m\`{a}xima $P$ que poden dissipar.

Els valors usuals de pot\`{e}ncia s\'{o}n: \SIlist{1/4;1/2;1;2;5;25}{W}.

Per tal de no fer malb\'{e} una resist\`{e}ncia, cal escollir un valor de pot\`{e}ncia superior al m\`{a}xim que la resist\`{e}ncia haur\`{a} de dissipar. Per tant, si el valor de la resist\`{e}ncia \'{e}s $R$, i la tensi\'{o} m\`{a}xima que haur\`{a} de suportar \'{e}s $U$, caldr\`{a} escollir un valor de pot\`{e}ncia $P$ que compleixi:
\begin{equation}
  P > \frac{U^2}{R}
\end{equation}
