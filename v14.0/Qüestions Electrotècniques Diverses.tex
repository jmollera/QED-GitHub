...
\usepackage[pages=some]{background} %Gradient de color en la portada
\backgroundsetup{
	scale=1,
	angle=0,
	opacity=1,
...
\newcommand{\AWGammSQ}{Secció en \unit{mm^2} d'un conductor AWG}
\newcommand{\mmSQaAWG}{Número AWG corresponent a una secció en \unit{mm^2}}
