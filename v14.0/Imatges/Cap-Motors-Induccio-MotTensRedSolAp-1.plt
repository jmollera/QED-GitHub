...
set arrow from 0.8, 0.097 to 0.8, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,8}$}' at 0.797, 0.0125 center rotate by -270 front
set arrow from 0.8, 0.097 to 0.75, 0.097 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,097}$}' at 0.766, 0.0935 left front
