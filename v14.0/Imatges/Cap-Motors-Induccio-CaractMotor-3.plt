...
set arrow from 1425.0, 0.887 to 1425.0, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1425}{r/min}$}' at 1408, 0.2 center rotate by -270 front
set arrow from 1425.0, 0.887 to 0.0, 0.887 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,887}$}' at 150, 0.91 center front
set arrow from 1425.0, 0.876 to 0.0, 0.876 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,876}$}' at 150, 0.85 center front
