...
set y2range [ -25.0000 : 25.0000 ] noreverse nowriteback
set zlabel "" 
...
ARGC = 0
ARG0 = ""
set terminal cairolatex pdf size 16cm,9cm
set output "Cap-Fourier-Exemple-Tensio.tex"
set object rectangle from 0,-25 to 16,25 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot 80.0/pi*(sum[k=1:6] sin((2*k-1)*0.2*pi*x)/(2*k-1)) linecolor rgb "red"  linewidth 6.000
#    EOF
