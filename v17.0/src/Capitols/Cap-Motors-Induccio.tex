...
\chapter{Motors d'Inducció Trifàsics}\label{sec:ch-motors-ind}\index{motors d'inducció}
...
\begin{ThreePartTable}
	\begin{TableNotes}
		\item[\color{blue}(a)] {\footnotesize També es fan servir els símbols no estàndard: «lb\ped{m}», «℔» i  «\#».}
	\end{TableNotes}
	\begin{longtable}[h]{llc}
...
Es donen en aquesta secció factors de conversió entre unitats angleses i llurs unitats equivalents del Sistema Internacional d'unitats (SI).\footnote{Aneu a l'apèndix \ref{sec:SI} per veure una explicació completa del Sistema Internacional d'unitats (SI).}
...
\begin{list}{}
   ...
   \item[$\cos\varphi$] Factor de potència, on $\varphi$ és l'angle entre el fasor de la tensió fase-neutre aplicada al motor i el fasor del corrent de fase absorbit pel motor.
\end{list}
...
\begin{equation}
 1\frac{\unit{rad}}{\unit{s}} \times \frac{\qty{60}{s}}{\qty{1}{min}} \times \frac{\qty{1}{r}}{2\pi\,\unit{rad}} = \frac{30}{\pi}\frac{\unit{r}}{\unit{min}}
 \end{equation}
...
\begin{align}
    n        &= \frac{30}{\pi} \,\omega \\[1ex]
    n\ped{m} &= \frac{30}{\pi} \,\omega\ped{m}
\end{align}
\end{subequations}
...
\begin{align}
    \omega\ped{sinc} &= 2 \pi f & n\ped{sinc} &= 60 f \\[1ex]
    \omega\ped{m,sinc} &= \frac{4 \pi f}{p} & n\ped{m,sinc} &= \frac{120 f}{p}\label{eq:vel-mec-sinc}
\end{align}
\end{subequations}
...
\begin{equation}
    S = \sqrt{3} U I = \frac{P}{\cos\varphi} = \frac{P\ped{m}}{\eta \cos\varphi}\label{eq:mot-S-Pm}
\end{equation}
...
\begin{align}
    ...
    \frac{\frac{\qty{1000}{W}}{\qty{1}{kW}}}{ \frac{\qty{1}{min}}{\qty{60}{s}} \times \frac{2\pi\,\unit{rad}}{\qty{1}{r}}} &=  \num{9549,2966}\, \frac{\unit{W}}{\unit{rad/s}} = \qty{9549,2966}{N.m} \\[1ex]
    \frac{\qty{1}{HP}}{1\frac{\unit{r}}{\unit{min}}} \times
    \frac{\frac{\qty{745,6999}{W}}{\qty{1}{HP}}}{ \frac{\qty{1}{min}}{\qty{60}{s}} \times \frac{2\pi\,\unit{rad}}{\qty{1}{r}}} &=  \num{7120,9095}\, \frac{\unit{W}}{\unit{rad/s}} = \qty{7120,9095}{N.m} \\[1ex]
    \frac{\qty{1}{CV}}{1\frac{\unit{r}}{\unit{min}}} \times
    \frac{\frac{\qty{735,4988}{W}}{\qty{1}{CV}}}{ \frac{\qty{1}{min}}{\qty{60}{s}} \times \frac{2\pi\,\unit{rad}}{\qty{1}{r}}} &=  \num{7023,4962}\, \frac{\unit{W}}{\unit{rad/s}} = \qty{7023,4962}{N.m}
\end{align}
\end{subequations}
...
En alguns llibres, articles i catàlegs, sobretot en anglès, en lloc d'utilitzar el símbol $J$ per designar el moment d'inèrcia, s'utilitza el símbol equivalent $WR^2$ (o també $Wk^2$). El sentit de $WR^2$ és clar si pensem que un moment d'inèrcia, que s'expressa en \unit{kg.m^2},  és el producte d'una massa o «pes» (\textit{weight} en anglès) multiplicada per un radi de gir al quadrat. També es poden veure en la nostra llengua, els símbols $GD^2$ i $PD^2$, on $D$ representa un diàmetre; en aquest cas, si en un catàleg tenim el valor de $GD^2$ o $PD^2$ expressat en \unit{kg.m^2}, caldrà dividir-lo per 4 per obtenir $J$, atès que es compleix: $R^2 = D^2/4$.
...
\begin{subequations}
\begin{align}
    \frac{\qty{1}{kg.m^2} \times \left(1\frac{\unit{r}}{\unit{min}} \times \frac{\qty{1}{min}}{\qty{60}{s}} \times \frac{2\pi\,\unit{rad}}{\qty{1}{r}}\right)^2}{2\times \qty{1}{kVA} \times \frac{\qty{1000}{VA}}{\qty{1}{kVA}}}  &= \qty{5,4831e-6}{s.rad^2.W/VA} \\[1ex]
   \frac{\qty{1}{lb.ft^2} \times \frac{\qty{4,214011e-2}{kg.m^2}}{\qty{1}{lb.ft^2}} \times \left(1\frac{\unit{r}}{\unit{min}} \times \frac{\qty{1}{min}}{\qty{60}{s}} \times \frac{2\pi\,\unit{rad}}{\qty{1}{r}}\right)^2}{2\times \qty{1}{kVA}  \times
...
\begin{subequations}
\begin{align}
    \frac{2\times \qty{1}{kVA} \times \frac{\qty{1000}{VA}}{\qty{1}{kVA}} \times 1 \frac{\unit{s.rad^2.W}}{\unit{VA}}}{\left(1\frac{\unit{r}}{\unit{min}} \times \frac{\qty{1}{min}}{\qty{60}{s}} \times \frac{2\pi\,\unit{rad}}{\qty{1}{r}}\right)^2}  &= \qty{1,8238e5}{kg.m^2} \\[1ex]
    \frac{2\times \qty{1}{kVA} \times \frac{\qty{1000}{VA}}{\qty{1}{kVA}} \times 1 \frac{\unit{s.rad^2.W}}{\unit{VA}}}{\left(1\frac{\unit{r}}{\unit{min}} \times \frac{\qty{1}{min}}{\qty{60}{s}} \times \frac{2\pi\,\unit{rad}}{\qty{1}{r}}\right)^2}  \times \frac{\qty{1}{lb.ft^2}}{\qty{4,214011e-2}{kg.m^2}} &= \qty{4,3279e6}{lb.ft^2}
\end{align}
\end{subequations}
...
A partir d'aquestes equacions diferencials podem trobar el temps que triga el motor a arrencar $t\ped{arr}$, integrant des de $\omega\ped{m}=0$ fins a $\omega\ped{m}=\omega\ped{m,fun}$ en la primera equació, o des de $s = 1$ fins a $s = s\ped{fun}$ en la segona:
\begin{subequations}
\begin{align}
...
Igual que en les equacions anteriors, els parells $T\ped{m}$ i $T\ped{load}$ varien en funció de $\omega\ped{m}$ en la primera equació, i en funció de $s$ en la segona. Aquestes integrals no es poden  resoldre  analíticament degut a llur complexitat; per tant,  han de resoldre's de forma aproximada utilitzant mètodes numèrics.\footnote{Vegeu la secció \ref{sec:int-mum}}


\begin{exemple}[\MotTempsArr{} \hyperlink{exemple:MotTempsArr}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:MotTempsArr}
...
Creem a continuació una nova taula de valors en unitats SI a partir de la taula dels valors donats. Multipliquem la primera columna per $\pi/30$ per obtenir la velocitat $\omega\ped{m}$ en \unit{rad/s}, i les dues columnes següents les multipliquem per \qty{1,355818}{N.m/(lbf.ft)} per obtenir els parells $T\ped{m}$ i $T\ped{load}$ en \unit{N.m}. Addicionalment, si ens fixem en l'equació \eqref{eq:tarr-mot}, veurem que la funció que hem d'integrar per obtenir el temps d'arrencada és $\frac{1}{T\ped{m}(\omega\ped{m})-T\ped{load}(\omega\ped{m})}$; creem, per tant, en la nova taula una quarta columna amb aquests valors.
...
\begin{align*}
    t\ped{arr} &\approx \qty{21,37}{kg.m^2} \times \bigg( \frac{(\num{0,002979}+\num{0,002773})\,\unit{N^{-1}.m^{-1}}}{2}
    \times (\num{9,425}-\num{0,000})\,\unit{rad/s}  \\
...
\begin{center}
    ...
    \captionof{figure}{Esquema elèctric equivalent d'un motor}
    \label{pic:mot-esq-equiv}
\end{center}

A continuació es dona el significat dels diversos paràmetres d'aquest esquema. Per no fer l'escriptura tan enrevessada, a partir d'ara es representarà el mòdul d'una variable complexa  directament com una variable real, és a dir en lloc de, per exemple, escriure $|\cmplx{U}_1|$ escriurem $U_1$:
...
Com es pot veure, el corrent $I\ped{1,arr}$ és directament proporcional a la tensió $U_1$, ja que $Z\ped{mot,arr}$ és un valor constant. Per tant, si la tensió es redueix, per exemple, al \qty{80}{\%} del seu valor nominal, el corrent d'arrencada també es reduirà al \qty{80}{\%}; en aquest cas el motor trigarà més temps a arrencar.
...
\begin{exemple}[\CaractMotor{} \hyperlink{exemple:CaractMotor}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:CaractMotor}
    ...
    \begin{align*}
        ...
        \omega\ped{m,sinc} &= \frac{4 \times\pi \times\qty{50}{Hz}}{4} =  \qty{157,080}{rad/s} \\[1ex]
 ...
 Trobem a continuació les equacions de $\cmplx{Z}\ped{mot}$ i $I_1$ en funció de $s$, utilitzant les equacions \eqref{eq:mot-Zmot} i \eqref{eq:mot-I1} respectivament:
    \begin{align*}
		\cmplx{Z}\ped{mot}(s) &= \complexqty{0,5+j1,5}{\ohm} + \frac{\complexqty{4,390+j39,512}{\ohm}\,\times\,
	      \left(\dfrac{\qty{0,625}{\ohm}}{s}\, + \, \complexqty{j1,25}{\ohm}\right)}{\complexqty{4,390+j39,512}{\ohm}\,+\,
	   \dfrac{\qty{0,625}{\ohm}}{s}\, + \,\complexqty{j1,25}{\ohm}} \\[0.5ex]
    ...
    \[
        I_2(s) = \frac{\qty{211,174}{V}}{\left| \complexqty{0,470+j1,448}{\ohm} + \dfrac{\qty{0,625}{\ohm}}{s} + \complexqty{j1,25}{\ohm} \right|}
    \]
  ...
  \]
    ...
    \begin{center}
        ...
        \input{Imatges/Cap-Motors-Induccio-CaractMotor-1.tex}
    \end{center}
	\vspace{-2mm}
	...
	\begin{center}
		\fontsize{10pt}{11pt}\selectfont
		\input{Imatges/Cap-Motors-Induccio-CaractMotor-2.tex}
	\end{center}	
	...
	\begin{center}
	\fontsize{10pt}{11pt}\selectfont
	\input{Imatges/Cap-Motors-Induccio-CaractMotor-3.tex}
	\end{center}	
...
\begin{center}
	...
	\captionof{figure}{Esquema elèctric equivalent de seqüència inversa d'un motor}
...
\begin{exemple}[\TensDeseqMotor{} \hyperlink{exemple:TensDeseqMotor}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:TensDeseqMotor}
...
En aquests casos les equacions que ens interessen són les \eqref{eq:Pm-I2-U1} i \eqref{eq:Tm-Prot-ws}, les quals relacionen la potència mecànica $P\ped{m}(s)$ i el parell mecànic $T\ped{m}(s)$ amb la tensió $U_1$ i el lliscament $s$. Per claredat, tornem a escriure aquí aquestes dues equacions:
\begin{subequations}
	\begin{align}
...
\begin{exemple}[\MotCarregaReduida{} \hyperlink{exemple:MotCarregaReduida}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:MotCarregaReduida}
	...
	A continuació  substituïm aquests valors en l'equació \eqref{eq:Pm-U1-Yeq} i la resolem.  Aquesta equació és clarament no lineal, i per resoldre-la cal utilitzar programes de càlcul o mètodes numèrics, com ara els explicats en l'apèndix \ref{sec:func-no-lin}. La solució és:
	\[
		s = 0{,}0226
	\]
	...
	\begin{center}
		\input{Imatges/Cap-Motors-Induccio-MotCarregaReduida-1.tex}
	\end{center}
	...
	\begin{center}
		\input{Imatges/Cap-Motors-Induccio-MotCarregaReduida-2.tex}
	\end{center}
...
\begin{exemple}[\MotTensRedSolAp{} \hyperlink{exemple:MotTensRedSolAp}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:MotTensRedSolAp}
	...
	A continuació cal substituir aquests valors en l'equació \eqref{eq:Pm-U1-Yeq} i resoldre-la. Aquesta equació és clarament no lineal, i per  resoldre-la cal utilitzar programes de càlcul o mètodes numèrics, com ara els explicats en l'apèndix \ref{sec:func-no-lin}. La solució és:
	\[
	s = 0{,}0971
	\]
	...
	\begin{center}
		\input{Imatges/Cap-Motors-Induccio-MotTensRedSolAp-1.tex}
	\end{center}
	...
	\begin{center}
		\input{Imatges/Cap-Motors-Induccio-MotTensRedSolAp-2.tex}
	\end{center}	
\end{exemple}
...
\begin{exemple}[\MotTensRedSolEx{} \hyperlink{exemple:MotTensRedSolEx}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:MotTensRedSolEx}
    ...
    \begin{center}
		\fontsize{10pt}{11pt}\selectfont
		\input{Imatges/Cap-Motors-Induccio-MotTensRedSolEx-1-1.tex}
	\end{center}	
	...
	\begin{center}
		\fontsize{10pt}{11pt}\selectfont
		\input{Imatges/Cap-Motors-Induccio-MotTensRedSolEx-1-2.tex}
	\end{center}
	...
	\vspace{-4mm}
	\begin{center}
		\input{Imatges/Cap-Motors-Induccio-MotTensRedSolEx-2-1.tex}
	\end{center}
	\vspace{-4mm}
	...
	\vspace{-4mm}
	\begin{center}
		\input{Imatges/Cap-Motors-Induccio-MotTensRedSolEx-2-2.tex}
	\end{center}
\end{exemple} 


\subsubsection{Arrencada a tensió reduïda, deguda al  corrent d'arrencada del motor}\index{motors d'inducció!arrencada a tensió reduïda, deguda al corrent d'arrencada del motor}
...
\begin{subequations}
	...
	\end{align}
\end{subequations}
\index{ETh@$\cmplx{E}\ped{Th}$}\index{ZTh@$\cmplx{Z}\ped{Th}$}
...
\begin{exemple}[\MotTensRedIarr{} \hyperlink{exemple:MotTensRedIarr}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:MotTensRedIarr}
	...
	\[
		\cmplx{Z}\ped{mot}(s) = \complexqty{0,5+j1,5}{\ohm} + \frac{\complexqty{4,390+j39,512}{\ohm}\,\times\,
		\left(\dfrac{\qty{0,625}{\ohm}}{s}\, + \, \complexqty{j1,25}{\ohm}\right)}{\complexqty{4,390+j39,512}{\ohm}\,+\,
		\dfrac{\qty{0,625}{\ohm}}{s}\, + \,\complexqty{j1,25}{\ohm}}
	\] 
	...
	\begin{center}
		\fontsize{10pt}{11pt}\selectfont
		\input{Imatges/Cap-Motors-Induccio-MotTensRedIarr-2.tex}
	\end{center}
\end{exemple}	



\subsection{Fase oberta}\label{sec:mot-fase.oberta}\index{motors d'inducció!fase oberta}
...
\begin{center}
	\input{Imatges/Cap-Motors-Induccio-Esq-Equiv-Fase-Oberta.pdf_tex}
	\captionof{figure}{Esquema elèctric equivalent d'un motor amb una fase oberta}
...
\begin{exemple}[\MotorFaseOberta{}
\hyperlink{exemple:MotorFaseOberta}{\large\textcolor{NavyBlue}{(\faPython)}}]\label{ex:MotorFaseOberta}
\addcontentsxms{\MotorFaseOberta}
	...
	\begin{align*}
		\cmplx{I}_{1,1} &= \frac{\complexqty{219,393:0}{V}}{2\times \left(\qty{0,5}{\ohm} + \dfrac{\qty{0,625}{\ohm}}{\num{0,05}\times(2-\num{0,05})} + j (\qty{1,5}{\ohm}+\qty{1,25}{\ohm}) \right)} = \complexqty{14,7:-21,70}{A} \\[1.5ex]
...
\begin{center}
	...
	\captionof{figure}{Punts característics d'una corba parell-velocitat d'un motor segons NEMA MG-1}
...
La norma NEMA MG-1 tracta aquesta qüestió de forma simplificada i en lloc de calcular les components simètriques de tensions i corrents, proporciona una gràfica que dona un factor reductor de la potència mecànica nominal, que anomenarem $\kappa\ped{P}$, en funció de desequilibris de tensions de fins al \qty{5}{\%}. El desequilibri de tensions $\Delta u$ el defineix com:

\begin{equation}
    \Delta u = \frac{\text{màxima desviació de la tensió respecte del valor mitjà de la tensió}}{\text{valor mitjà de la tensió}}
\end{equation}

En la figura \vref{pic:Du-kp-ki} es representa aquest factor reductor $\kappa\ped{P}$ en funció de $\Delta u$.

\begin{center}
    \input{Imatges/Cap-Motors-Induccio-U-Deseq.tex}
    \captionof{figure}{Tensió d'alimentació desequilibrada en motors segons NEMA MG-1}
    \label{pic:Du-kp-ki}
\end{center}



\begin{exemple}[\MotorTensDeseqNEMA{}]
...
Es tracta de trobar el factor $\kappa\ped{P}$  i el valor de la potència nominal corregida, en els dos casos següents:	
    ...
    \[
        \Delta u = \frac{\qty{9}{V}}{\qty{459}{V}} = \num{0,02} = \qty{2}{\%}
    \]
	 ...
	 \[
	 \Delta u = \frac{\qty{19,3}{V}}{\qty{379,7}{V}} = \num{0,05} = \qty{5}{\%}
	 \]
...
\begin{exemple}[\MotorVarParamTensFreq{}]
...
\begin{itemize}
	...
	\item Si disminuïm la tensió  per mantenir la relació $U/f$ constant, mantindrem els valors del parell i del corrent, i disminuirem el valor de la potència. Si necessitem més potència caldrà escollir un motor de potència nominal superior.
\end{itemize}
...
\begin{itemize}
	...
	\item Si augmentem la tensió per  mantenir la relació $U/f$ constant, mantindrem els valors del parell i del corrent, i augmentarem el valor de la potència. Cal comprovar que aquest augment de tensió està dins dels marges de funcionament del motor.
\end{itemize}
