...
\addcontentsline{toc}{section}{Versió 1.0 (8 de gener de 2005)}
...
\addcontentsline{toc}{section}{Versió 1.1 (8 de febrer de 2005)}
...
\addcontentsline{toc}{section}{Versió 1.2 (16 d'abril de 2005)}
...
\addcontentsline{toc}{section}{Versió 1.3 (24 d'octubre de 2005)}
...
\addcontentsline{toc}{section}{Versió 1.4 (2 de desembre de 2005)}
...
\addcontentsline{toc}{section}{Versió 2.0 (3 d'agost de 2006)}
...
\begin{itemize}
   \item Els capítols 1 i 2  de la versió 1.4 mantenen llur posició.
   ...
   \item Els capítols 4, 5, 6 i 7  de la versió 1.4 es desplacen tres números cap
    ...
    \item Els apèndixs A, B, C i D de la versió 1.4 mantenen llur posició.
...
\addcontentsline{toc}{section}{Versió 2.1 (2 de gener de 2007)}
...
\addcontentsline{toc}{section}{Versió 2.2 (10 de març de 2008)}
...
Es revisa l'apèndix C utilitzant les recomanacions de l'any 2006 del \textit{Committee on Data for Science and Technology} (CODATA).

\section*{Versió 3.0 (1 d'octubre de 2008)}
\addcontentsline{toc}{section}{Versió 3.0 (1 d'octubre de 2008)}
...
\addcontentsline{toc}{section}{Versió 3.1 (5 de desembre de 2009)}
...
\addcontentsline{toc}{section}{Versió 3.2 (5 de gener de 2010)}
S'afegeix l'apartat Bibliografia després dels apèndixs.


\section*{Versió 4.0 (15 de febrer de 2010)}
\addcontentsline{toc}{section}{Versió 4.0 (15 de febrer de 2010)}
...
\addcontentsline{toc}{section}{Versió 4.1 (27 de febrer de 2010)}
...
\addcontentsline{toc}{section}{Versió 4.2 (12 de març de 2010)}
...
\addcontentsline{toc}{section}{Versió 4.3 (27 de novembre de 2010)}
...
\addcontentsline{toc}{section}{Versió 4.4 (31 de març de 2011)}
...
\addcontentsline{toc}{section}{Versió 4.5 (2 de novembre de 2011)}
...
\addcontentsline{toc}{section}{Versió 4.6 (21 de novembre de 2011)}
...
\addcontentsline{toc}{section}{Versió 5.0 (30 de gener de 2012)}
...
\addcontentsline{toc}{section}{Versió 5.1 (15 de febrer de 2012)}
...
\addcontentsline{toc}{section}{Versió 5.2 (4 de maig de 2012)}
...
\addcontentsline{toc}{section}{Versió 5.3 (14 de juliol de 2012)}
...
\addcontentsline{toc}{section}{Versió 5.4 (2 de novembre de 2012)}
...
Es revisa l'apèndix C utilitzant les recomanacions de l'any 2010 del \textit{Committee on Data for Science and Technology} (CODATA).

\section*{Versió 5.5 (1 de desembre de 2012)}
\addcontentsline{toc}{section}{Versió 5.5 (1 de desembre de 2012)}
...
\addcontentsline{toc}{section}{Versió 6.0 (2 de gener de 2013)}
...
\addcontentsline{toc}{section}{Versió 6.1 (1 de febrer de 2013)}

S'afegeix un segon exemple en la secció 1.1.2, dedicat al teorema de Millman.


\section*{Versió 6.2 (11 de setembre de 2013)}
\addcontentsline{toc}{section}{Versió 6.2 (11 de setembre de 2013)}
...
\addcontentsline{toc}{section}{Versió 6.3 (24 de març de 2014)}
...
\addcontentsline{toc}{section}{Versió 7.0 (24 de juliol de 2014)}
...
\addcontentsline{toc}{section}{Versió 7.1 (23 d'octubre de 2014)}

S'afegeixen algunes normes en la secció 12.8.


\section*{Versió 8.0 (9 de novembre de 2014)}
\addcontentsline{toc}{section}{Versió 8.0 (9 de novembre de 2014)}
...
En la secció 1.4.2, dedicada a la potència trifàsica, se substitueixen els subíndexs «$\alpha$», «$\beta$», «$\gamma$» i «$\nu$», pels subíndexs «A», «B», «C» i «N», a l'hora d'identificar les tres fases  i el neutre d'un sistema trifàsic.
...
En la secció 2.4, dedicada a la transformació estrella-triangle d'impedàncies, se substitueixen els subíndexs «$\alpha$», «$\beta$» i «$\gamma$», pels subíndexs «A», «B» i «C», a l'hora d'identificar les tres fases d'un sistema trifàsic.

En el capítol 3, dedicat a les components simètriques, se substitueixen els superíndexs «(1)», «(2)» i «(0)», pels subíndexs «1», «2» i «0», a l'hora d'identificar les components directa, inversa i homopolar. A més, també se substitueixen els subíndexs «$\alpha$», «$\beta$», «$\gamma$» i «$\nu$», pels subíndexs «A», «B»,  «C» i «N», a l'hora d'identificar les tres fases i el neutre d'un sistema trifàsic.
...
\addcontentsline{toc}{section}{Versió 8.1 (16 de novembre de 2014)}
...
\addcontentsline{toc}{section}{Versió 9.0 (29 d’agost de 2016)}
...
Es modifica en tot el llibre la manera de representar una variable acompanyada de les seves unitats. Les variables se separaran de llurs unitats mitjançant el símbol de divisió «/», en lloc de tancar les unitats entre «[» i  «]»; per exemple, en lloc de $S\unit{[mm^2]}$, a partir d'ara escriurem $S/\unit{mm^2}$.
...
S'amplien algunes seccions i exemples del llibre, afegint-hi una  resolució numèrica mitjançant la calculadora \textsf{HP Prime};  aquesta calculadora disposa d'un emulador per a PC que pot descarregar-se gratuïtament. Les seccions i els exemples afectats són els següents:
\begin{itemize}
...
Es revisa la taula B.6 i l'apèndix C, utilitzant les recomanacions de l'any 2014 del \textit{Committee on Data for Science and Technology} (CODATA).
...
\addcontentsline{toc}{section}{Versió 9.1 (27 de novembre de 2016)}
...
\addcontentsline{toc}{section}{Versió 10.0 (6 de gener de 2017)}
...
En l'apèndix A, es donen les adreces d'Internet dels diccionaris utilitzats per escriure els noms de les lletres gregues en anglès i francès. Addicionalment, es corregeix el nom en francès de la lletra $\varpi$; el nom correcte és \textit{pi dorien}.

En l'apèndix B, es té en compte el suplement de l'any 2014 publicat pel  \textit{Bureau International des Poids et Mesures} (BIPM), el qual posa al dia la 8a edició de  l'any 2006. Els canvis introduïts que afecten aquest llibre, són els següents:
\begin{itemize}
...
\addcontentsline{toc}{section}{Versió 10.1 (8 de març de 2017)}

S'afegeix una figura al final de la secció 12.1, per iŀlustrar la diferència entre les funcions de protecció 50, 50TD i 51, i l'equació de les corbes característiques de la funció de protecció 51, amb els valors dels paràmetres utilitzats per les normes CEI i IEEE.

\section*{Versió 10.2 (7 de maig de 2017)}
\addcontentsline{toc}{section}{Versió 10.2 (7 de maig de 2017)}
...
\addcontentsline{toc}{section}{Versió 10.3 (3 de juny de 2017)}

Es millora l'explicació de l'apartat 11.5.

\section*{Versió 10.4 (28 d'agost de 2017)}
\addcontentsline{toc}{section}{Versió 10.4 (28 d'agost de 2017)}
...
\addcontentsline{toc}{section}{Versió 10.5 (11 de setembre de 2017)}
...
\addcontentsline{toc}{section}{Versió 10.6 (1 d'octubre de 2017)}
...
En l'apartat Notació, s'inclou una nota per indicar  que el valor de l'angle $\psi$ ha d'expressar-se sempre en radians, perquè el valor de $e^{j\psi}$ sigui correcte.
...
\addcontentsline{toc}{section}{Versió 10.7 (18 de febrer de 2018)}
...
\addcontentsline{toc}{section}{Versió 10.8 (23 de maig de 2018)}

Es fan algunes correccions en el text.


\section*{Versió 11.0 (26 de juny de 2019)}
\addcontentsline{toc}{section}{Versió 11.0 (26 de juny de 2019)}
...
\addcontentsline{toc}{section}{Versió 11.1 (7 de juliol de 2019)}
...
\addcontentsline{toc}{section}{Versió 11.2 (25 d'agost de 2019)}
...
\addcontentsline{toc}{section}{Versió 11.3 (5 de setembre de 2019)}
...
\addcontentsline{toc}{section}{Versió 11.4 (6 d'octubre de 2019)}
...
\addcontentsline{toc}{section}{Versió 11.5 (25 de novembre de 2019)}
...
\addcontentsline{toc}{section}{Versió 11.6 (18 de gener de 2020)}
...
\addcontentsline{toc}{section}{Versió 11.7 (21 de juliol de 2020)}
...
\addcontentsline{toc}{section}{Versió 12.0 (9 de gener de 2021)}
...
\addcontentsline{toc}{section}{Versió 13.0 (20 de juliol de 2021)}
...
Es millora la figura 1.9 afegint-hi la lletra $\alpha$ que faltava  a baix a l'esquerra.
...
En els apèndixs  B i C, es modifiquen les unitats de la constant de Planck, passant de \unit{J.s} a \unit{J/Hz}; aquest canvi es fa d'acord amb  la recomanació de l'any 2018 del \textit{Committee on Data for Science and Technology} (CODATA).
...
El paquet d'ampliació de \LaTeX{} \texttt{siunitx}, utilitzat per escriure valors numèrics i unitats, ha sofert un gran canvi en passar de la versió 2 a la 3. Aquest canvi ha obligat a fer una  revisió total d'aquest llibre per  fer-lo compatible amb aquesta nova versió.
...
\addcontentsline{toc}{section}{Versió 13.1 (20 d'agost de 2021)}
...
\addcontentsline{toc}{section}{Versió 13.2 (16 d'octubre de 2021)}
...
\addcontentsline{toc}{section}{Versió 13.3 (5 de gener de 2022)}

Es millora l'explicació de la secció E.2 i es corregeix l'equació (E.12).


\section*{Versió 14.0 (29 de juliol de 2022)}
\addcontentsline{toc}{section}{Versió 14.0 (29 de juliol de 2022)}
...
Es modifiquen els noms de les funcions de l'apèndix F, per igualar-les amb els noms de les funcions del mòdul Python \texttt{qed.eng\_elc} del capítol 15.
...
\addcontentsline{toc}{section}{Versió 14.1 (14 d'agost de 2022)}

Es revisa tot el text, fent-hi petites correccions.


\section*{Versió 14.2 (2 de gener de 2023)}
\addcontentsline{toc}{section}{Versió 14.2 (2 de gener de 2023)}
...
\addcontentsline{toc}{section}{Versió 14.3 (24 d'abril de 2023)}
...
\begin{itemize}
	\item Llistats 16.20, 16.22 i 16.23. Es modifiquen aquests programes, per fer ús de la classe \texttt{Motor3ph}.
	\item Llistat 16.24. S'amplia aquest programa, fent ús de la classe \texttt{Motor3ph}, per  calcular el temps que triga el motor a arrencar, al 100 \% i al 80 \% de la tensió nominal, i per representar l'evolució temporal del corrent d'arrencada a aquestes dues tensions.
	\item  Llistat 16.25. S'amplia aquest programa, fent ús de la classe \texttt{Motor3ph}, per  calcular el temps que triga el motor a arrencar, i per representar l'evolució temporal del  corrent d'arrencada i de la tensió en el motor.
\end{itemize}

A la secció A.1, s'indica que la publicació més recent del \textit{Bureau 	International des Poids et Mesures} del Sistema Internacional d'unitats, és la  9a edició de març de 2019, revisada el desembre de 2022 per afegir-hi els nous prefixos dels factors $10^{27}$,  $10^{30}$,  $10^{-27}$ i  $10^{-30}$.
...
\addcontentsline{toc}{section}{Versió 14.4 (2 de maig de 2023)}
...
\addcontentsline{toc}{section}{Versió 14.5 (18 de maig de 2023)}
...
Es modifica  la manera d'escriure els valors complexos en forma polar, per adaptar-la a la forma estàndard. A partir d'ara, en lloc d'escriure, per exemple, $230_{\angle\ang{120}}$, escriurem \complexnum{230:120}.
...
\addcontentsline{toc}{section}{Versió 14.6 (3 de juny de 2023)}
...
\addcontentsline{toc}{section}{Versió 14.7 (2 de gener de 2024)}
...
\section*{Versió 14.8 (9 de juny de 2024)}
\addcontentsline{toc}{section}{Versió 14.8 (9 de juny de 2024)}
...
\section*{Versió 15.0 -- 20è Aniversari (8 de gener de 2025)}
\addcontentsline{toc}{section}{Versió 15.0 -- 20è Aniversari (8 de gener de 2025)}

Es revisa tot el text fent-hi petites correccions.

S'inclouen notes a peu de pàgina  amb enllaços a articles de la \textit{Wikipedia} que descriuen la biografia dels personatges citats en el text.
...
En el capítol 15 es millora la programació del mòdul  \texttt{qed.eng\_elec}:
\begin{itemize}
	\item S'afegeix la constant \texttt{SQRT3} equivalent al valor $\sqrt{3}$.
	\item S'elimina l'excepció \texttt{EEInvalidElement}; els errors que tornaven aquesta excepció, ara tornen l'excepció \texttt{EEInvalidArguments}. 
	\item S'elimina la classe \texttt{EE}, que definia un conjunt de constants, i se'n creen quatre de noves per suplir-la: \texttt{CableType}, \texttt{IECcurve}, \texttt{IEEEcurve} i \texttt{Speed}; les constants definides en aquestes classes es fan servir en les funcions \texttt{z\_cable} i \texttt{curve\_51}, i en el mètode \texttt{speed} de la classe \texttt{Motor3ph}.
	\item Es modifica la funció \texttt{voltage\_drop}, afegint-hi la possibilitat que torni el valor aproximat ---a més de l'exacte--- de la caiguda de tensió.
	\item Es crea la funció \texttt{curve\_51}, la qual substitueix a les antigues \texttt{CEI\_51\_curve} i \texttt{IEEE\_51\_curve}.
	\item S'eliminen les classes \texttt{Branch} i \texttt{CoupledBranches}, les quals ja no són necessàries per afegir elements amb el mètode \texttt{add} de la classe \texttt{Network}, i es crea la  classe \texttt{MutualCoupling}, per afegir branques acoblades amb aquest mètode \texttt{add}. 
	\item S'eliminen les classes \texttt{VoltageSourceIdeal} i \texttt{CurrentSourceIdeal}, les quals ja no són necessàries per afegir fonts ideals de tensió o de corrent amb el mètode \texttt{add} de la classe \texttt{Network}. Una font de tensió ideal es pot afegir ara fent servir la classe \texttt{VoltageSource}, incloent-hi només el valor \texttt{E}, i no el \texttt{Z} (que passa a tenir el valor per defecte \texttt{None}). Una font de corrent ideal es pot afegir ara fent servir la classe \texttt{CurrentSource}, incloent-hi només el valor \texttt{J}, i no l'\texttt{Y} (que passa a tenir el valor per defecte \texttt{None}).
	\item Es milloren els mètodes \texttt{\_\_str\_\_} i \texttt{results} de la classe \texttt{Network}, per  donar una informació més completa dels nusos i les branques de la xarxa.
	\item Es crea el mètode \texttt{\_\_bool\_\_} de la classe \texttt{Network}, el qual torna \texttt{False} si la xarxa no conté cap element, i \texttt{True} en cas contrari.
	\item La representació interna de la classe \texttt{Network} ha canviat; això fa que els seus mètodes \texttt{load} i  \texttt{save} no siguin compatibles amb les versions anteriors. 
	\item S'elimina la classe  \texttt{Motor3phStartUp} i el mètode  \texttt{start\_up} de la classe  \texttt{Motor3ph}; es creen a canvi els mètodes   \texttt{t\_start} i  \texttt{s\_start\_up}, amb la mateixa funcionalitat. 	El mètode \texttt{s\_start\_up} dona  resultats més precisos; en lloc de la  funció \texttt{cumulative\_trapezoid} de la llibreria \texttt{SciPy}, fa servir la funció \texttt{cumulative\_simpson} de la mateixa llibreria, la qual està disponible a partir de la versió 1.12.0. 
	\item Es crea el mètode \texttt{convert} de la classe \texttt{Motor3ph}, el qual substitueix als antics mètodes \texttt{to\_s},  \texttt{to\_$\omega$\_m} i \texttt{to\_n\_m}.
	\item Es crea el mètode  \texttt{\_\_str\_\_} de la classe \texttt{Motor3ph}, el qual permet imprimir de forma tabulada els paràmetres del motor.
\end{itemize}
	
 
A la secció A.1, s'indica que la publicació més recent del \textit{Bureau 	International des Poids et Mesures} del Sistema Internacional d'unitats, és la  9a edició de març de 2019, revisada l'agost de 2024 per millorar la descripció dels angles i de les 
magnituds unitàries. Els canvis queden restringits a la taula A.4.

S'amplia la secció A.7.1. S'incorporen a la taula \ref{taula:prefix-inform} els prefixes binaris «robi» i «quebi», els quals s'inclouran en la pròxima revisió de la norma CEI 80000-13:2024, actualment en estat d'esborrany.

S'actualitza l'apèndix  B amb els nous valors recomanats de les constants físiques  l'any 2022 pel \textit{Committee on Data for Science and Technology} (CODATA). S'han afegit constants a la taula B.1.
...
Es crea la secció E.1 incloent-hi el text que en edicions anteriors estava a l'inici de l'apèndix E; al final d'aquesta secció s'afegeix la indicació d'on es poden obtenir els fitxers dels programes de la calculadora \textsf{HP Prime} descrits en les seccions següents d'aquest apèndix.

En l'apartat Bibliografia s'afegeixen les referències \cite{KRE}, \cite{SAL}  i \cite{MGIO}.


\section*{Versió 16.0 -- 21è Aniversari (\today)}
\addcontentsline{toc}{section}{Versió 16.0 -- 21è Aniversari (8 de gener de 2026)}

Es revisa tot el text fent-hi petites correccions.

S'unifica la font utilitzada per a les lletres gregues a la \texttt{Euler}; és la mateixa font que es fa servir per a les expression i variables matemàtiques.

Es millora l'exposició de la secció \ref{sec:pot-inst-act-react}, pel que fa a  l'obtenció de les equacions de les potències activa i reactiva.

Es millora l'exposició de la secció \ref{sec:resistencies-colors}, pel què fa a l'explicació del significat de cadascuna de les bandes de color de les resistències.

Es fan els següents canvis, relacionats amb l'index horari dels transformadors trifàsics:
\begin{itemize}
    \item S'indica en la secció \ref{sec:connex-index-horari} que no  tots els índexs horaris són possibles.
    \item Es corregeix l'exemple \ref{ex:IccTrafos}, ja que en el cas del transformador YNyn s'havia fet servir un índex horari que no era possible. Addicionalment, es millora la representació de les figures de l'exemple, afegint explícitament la connexió a terra dels generadors.
    \item En la secció \ref{sec:trafo-cond-min-connex}, es millora l'explicació  dels índexs horaris que són compatibles entre si a l'hora de connectar en paraŀlel dos transformadors.
\end{itemize}

S'amplia la secció \ref{sec:xarxes-curtcircuits} per explicar el mètode de càlcul sistemàtic de les tensions i corrents que apareixen en totes les branques d'una xarxa, quan hi ha un curtcircuit entre dos nusos.
Es modifica l'exemple \ref{ex:CurtcircuitXarxaComplexa}, per adaptar-lo a aquest mètode de càlcul.

S'ha actualitzat la distribució de Python utilitzada per executar els programes d'aquest llibre; els canvis més significatius són l'ús de la versió 3.13 de Python, el pas de la versió 1.x a la 2.x de la llibreria \texttt{numpy}, i el pas de la versió 2.x a la 3.x de la llibreria \texttt{pandapower}. Els canvis i millores que s'han dut a terme són els següents:
\begin{itemize}
    \item En el mòdul \texttt{qed.utils} s'ha modificat la implementació  de la classe \texttt{Complex}, fent obligatori l'ús del paràmetre \texttt{in\_rad}; aquest canvi afecta a l'ús extern d'aquesta classe. A més, s'ha inclòs la possibilitat de definir el símbol del separador entre el módul i l'argument,  el del grau sexagesimal i el del radian, afegint a la classe les variables \texttt{angle\_symbol}, \texttt{degree\_symbol} i \texttt{rad\_symbol}.
     S'han creat les subclasses \texttt{ComplexR} i \texttt{ComplexD} per manipular nombres complexos polars en radians i en graus respectivament,  sense la necessitat d'especificar el paràmetre \texttt{in\_rad} de la classe pare \texttt{Complex}.

    \item En el mòdul \texttt{qed.eng\_elc} s'ha modificat la implementació  de la classe \texttt{Network}, afegint a la funció \texttt{\_\_init\_\_} els membres  \texttt{ideal\_Z} i \texttt{ideal\_Y}, amb el valor 1 per defecte. El motiu d'aquest canvi és donar la flexibilitat a l'usuari d'escollir altres valors per a \texttt{ideal\_Z} i \texttt{ideal\_Y}, si considera que poden ser més adequats en relació a les magnituds de la resta de valors  dels components de la xarxa. Donat que la representació interna de la classe \texttt{Network} ha canviat, els mètodes \texttt{load} i  \texttt{save} no són compatibles amb les versions anteriors.

    \item En el mòdul \texttt{qed.eng\_elc} s'ha modificat la implementació  de la classe \texttt{MutualCoupling}, eliminat la restricció de que el valor de l'acoblament fos un nombre complex sense part real.
     Per fer evident aquesta circumstància, s'ha canviat el nom de la variable de la classe de \texttt{X} a  \texttt{ZM}. Aquest canvi afecta a l'ús extern d'aquesta classe.

    \item En el mòdul \texttt{qed.eng\_elc} s'ha modificat la implementació  de la classes \texttt{Motor3ph}, eliminat els mètodes \texttt{t\_start} i \texttt{s\_start\_up}, i creant  el nou mètode \texttt{start\_up}, que torna alhora els resultats que proporcionaven per separat els dos mètodes eliminats;
     aquest dos resultats es tornen en una nova \texttt{dataclass}, que els agrupa, anomenada \texttt{Motor3phStartUp}.
     Aquest canvi afecta a l'ús extern de la classe \texttt{Motor3ph}.

    \item En el mòdul \texttt{qed.eng\_elc} s'ha modificat la implementació  de la classe \texttt{Speed}, canviant-ne els noms dels elements interns; això afecta a l'ús extern d'aquesta classe.

    \item Ha calgut modificar el programa \texttt{Exemple-12-3.py}, afegint el paràmetre \texttt{tap\_changer\_type ='Ratio'} a la funció \texttt{create\_transformer\_from\_parameters}.
     Aquesta modificació és deguda al canvi de versió de la llibreria \texttt{pandapower}.

    \item Es deixa de fer servir la funció \texttt{interp1d} de la llibreria \texttt{SciPy} per fer interpolacions, en favor de  la funció \texttt{make\_interp\_spline} de la mateixa llibreria.
    La documentació de la llibreria \texttt{SciPy} indica que la  funció \texttt{interp1d} ja no es posarà més al dia, i en desaconsella el seu ús.
\end{itemize}

A la secció \ref{sec:SI-intro}, s'indica que la publicació més recent del \textit{Bureau 	International des Poids et Mesures} del Sistema Internacional d'unitats, és la  9a edició de març de 2019, revisada l'agost de 2025 per incloure els prefixes binaris «robi» i «quebi», i per actualitzar el valor del dalton.

A la secció \ref{sec:bit-octet-byte} s'indica que els prefixes binaris «robi» i «quebi»  s'han inclòs en la revisió de la norma CEI 80000-13:2025.

A la secció \ref{sec:normes-escript} s'afegeixen algunes normes d'escriptura, se n'elimina alguna, i se'n modifiquen d'altres, per mirar de  fer-ho tot plegat més entenedor.

S'han afegit constants a la taula \ref{taula:Const-Fis}, i s'ha ampliat l'explicació que hi ha a continuació.

S'amplia l'equació \eqref{eq:trap-uneven} amb una expressió alternativa que requereix menys càlculs.

Es modifica el llistat \ref{lst:trap-rule} de la funció \texttt{Trapezoidal\_Rule}, utilitzant l'expressió alternativa de l'equació \eqref{eq:trap-uneven}.

En l'apartat Bibliografia, s'afegeix la referència \cite{SSMH}.


\section*{Versió 17.0 -- 22è Aniversari (\today)}
\addcontentsline{toc}{section}{Versió 17.0 -- 22è Aniversari ()}

Es crea el nou capítol 13 dedicat als curtcircuits.
El capítol 13 de la versió 16.0, passa a ser el capítol 14.
S'actualtza el Prefaci per recollir aquest canvis.

En l'apèndix \ref{sec:progs-HP}, s'afegeixen les funcions \texttt{Simpson\_1\_3\_Rule} i \texttt{Simpson\_3\_8\_Rule}.
