...
es trobi l'angle $\alpha$. \textbf{I}: $\alpha\in[0,\frac{\pi}{2}]$, \textbf{II}:
$\alpha\in[\frac{\pi}{2},\pi]$, \textbf{III}:
$\alpha\in[\pi,\frac{3\pi}{2}]$, \textbf{IV}:
...
\begin{subequations}
\begin{align}
    \sin(\pi\pm\alpha) &= \mp\sin\alpha  & \csc(\pi\pm\alpha) &= \mp\csc\alpha \\[1.5ex]
    \cos(\pi\pm\alpha) &= -\cos\alpha    & \sec(\pi\pm\alpha) &= -\sec\alpha \\[1.5ex]
...
\begin{align}
    ...
    \cos\frac{\alpha-\beta}{2}\\[1ex]
    \sin\alpha-\sin\beta &= 2 \cos\frac{\alpha+\beta}{2}
    \sin\frac{\alpha-\beta}{2}\\[1ex]
...
La fórmula de Mollweide,\footnote{Karl Mollweide, matemàtic alemany: \href{https://en.wikipedia.org/wiki/Karl_Mollweide}{https:/\!\!/en.wikipedia.org/wiki/Karl\_Mollweide}.} la qual inclou alhora els tres costats i els tres angles interiors d'un triangle, ens dona les relacions següents:\index{formula@fórmula!de Mollweide}
\begin{subequations}
\begin{align}
...
\begin{subequations}
\begin{align}
    \sinh z_1+\sinh z_2 &= 2 \sinh\frac{z_1+z_2}{2}
    \cosh\frac{z_1-z_2}{2}\\[1ex]
    \sinh z_1-\sinh z_2 &= 2 \cosh\frac{z_1+z_2}{2}
    \sinh\frac{z_1-z_2}{2}\\[1ex]
    \cosh z_1+\cosh z_2 &= 2 \cosh\frac{z_1+z_2}{2}
    \cosh\frac{z_1-z_2}{2}\\[1ex]
    \cosh z_1-\cosh z_2 &= 2 \sinh\frac{z_1+z_2}{2}
    \sinh\frac{z_1-z_2}{2}
\end{align}
\end{subequations}
...
\begin{center}
	\input{Imatges/Ape-Trigonometria-sin.tex}
	\captionof{figure}{Funció sinus} 
\end{center}\index{sin}

\begin{center}
	\input{Imatges/Ape-Trigonometria-csc.tex}
	\captionof{figure}{Funció cosecant} 
\end{center}\index{csc}

\vspace{5mm}
\begin{center}
	\input{Imatges/Ape-Trigonometria-cos.tex}
	\captionof{figure}{Funció cosinus} 
\end{center}\index{cos}

\vspace{5mm}
\begin{center}
	\input{Imatges/Ape-Trigonometria-sec.tex}
	\captionof{figure}{Funció secant} 
\end{center}\index{sec}

\begin{center}
	\input{Imatges/Ape-Trigonometria-tan.tex}
	\captionof{figure}{Funció tangent} 
\end{center}\index{tan}

\vspace{5mm}
\begin{center}
	\input{Imatges/Ape-Trigonometria-cot.tex}
	\captionof{figure}{Funció cotangent} 
\end{center}\index{cot}

\begin{center}
	\input{Imatges/Ape-Trigonometria-sinh.tex}
	\captionof{figure}{Funció sinus hiperbòlic} 
\end{center}\index{sinh}

\begin{center}
	\input{Imatges/Ape-Trigonometria-csch.tex}
	\captionof{figure}{Funció cosecant hiperbòlica} 
\end{center}\index{csch}

\vspace{5mm}
\begin{center}
	\input{Imatges/Ape-Trigonometria-cosh.tex}
	\captionof{figure}{Funció cosinus hiperbòlic} 
\end{center}\index{cosh}

\vspace{5mm}
\begin{center}
	\input{Imatges/Ape-Trigonometria-sech.tex}
	\captionof{figure}{Funció secant hiperbòlica} 
\end{center}\index{sech}

\begin{center}
	\input{Imatges/Ape-Trigonometria-tanh.tex}
	\captionof{figure}{Funció tangent hiperbòlica} 
\end{center}\index{tanh}

\vspace{5mm}
\begin{center}
	\input{Imatges/Ape-Trigonometria-coth.tex}
	\captionof{figure}{Funció cotangent hiperbòlica} 
\end{center}\index{coth}
