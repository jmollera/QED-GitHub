from qed.eng_elec import Motor3ph, A012_to_ABC, SQRT3
...
I_1_2 = -I_1_1
I_1_0 = 0
print(f'I_1_1 = {ComplexD(I_1_1):.1f/.2f}')
print(f'I_1_2 = {ComplexD(I_1_2):.1f/.2f}')
print(f'I_1_0 = {ComplexD(I_1_0):.1f/.2f}\n')

I_1_A, I_1_B, I_1_C = A012_to_ABC(I_1_0, I_1_1, I_1_2)
print(f'I_1_A = {ComplexD(I_1_A):.1f/.2f}')
print(f'I_1_B = {ComplexD(I_1_B):.1f/.2f}')
print(f'I_1_C = {ComplexD(I_1_C):.1f/.2f}\n')
