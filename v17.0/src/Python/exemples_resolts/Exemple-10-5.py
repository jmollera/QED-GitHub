...
print(f'U_AB = {ComplexD(U_AB):z.2f} V')
print(f'U_BC = {ComplexD(U_BC):z.2f} V')
print(f'U_CA = {ComplexD(U_CA):z.2f} V\n')

U_AB_0, U_AB_1, U_AB_2 = ABC_to_A012(U_AB, U_BC, U_CA)
print(f'U_AB,1 = {ComplexD(U_AB_1):z.2f} V')
print(f'U_AB,2 = {ComplexD(U_AB_2):z.2f} V')
print(f'U_AB,0 = {ComplexD(U_AB_0):z.2f} V\n')

U_AN_1, U_AN_2 = AB12_to_AN12(U_AB_1, U_AB_2)
U_rel = abs(U_AN_2/U_AN_1)
print(f'U_AN,1 = {ComplexD(U_AN_1):z.2f} V')
print(f'U_AN,2 = {ComplexD(U_AN_2):z.2f} V')
...
print(f'I_1,n,1 = {ComplexD(I_1_n_1):z.2f} A')
print(f'I_1,n,2 = {ComplexD(I_1_n_2):z.2f} A')
print(f'I_1,n,2/I_1,n,1 = {I_rel:.3f}\n')

I_1_n_A, I_1_n_B, I_1_n_C = A012_to_ABC(0, I_1_n_1, I_1_n_2)
print(f'I_1,n,A = {ComplexD(I_1_n_A):z.2f} A')
print(f'I_1,n,B = {ComplexD(I_1_n_B):z.2f} A')
print(f'I_1,n,C = {ComplexD(I_1_n_C):z.2f} A')
