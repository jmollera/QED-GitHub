...
Scc_sist = 5  # MVA
X_R_sist = 9  # Relació X/R
L_cable = 80  # m
R_cable = 3.960  # Ω/km/fase
X_cable = 0.123  # Ω/km/fase
J = 2.1  # kg·m²

U_1_ext = U_sist / SQRT3
fase = np.arctan(X_R_sist)
...
print(f'U_1,arr = {ComplexD(mot_arr.U):.3f} V')
...
mot_start_up = motor.start_up(T_load, J, *font_ext)
print(f't_arr = {mot_start_up.t_start:.1f} s')
...
s_t_arr = mot_start_up.s_at_time(t_arr)
