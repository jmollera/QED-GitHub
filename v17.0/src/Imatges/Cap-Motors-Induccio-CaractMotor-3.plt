...
set key title ""
#set key inside center top vertical Left reverse enhanced box
set key at 1250, 0.25  Left reverse  box
set key noinvert samplen 2 spacing 1.5 width 4.5 height 0.5 
...
set ytics 0.0,0.1,1.0 norangelimit textcolor rgb "black" 
...
set ylabel  '$\cos\varphi, \quad \eta$'
set ylabel  font "" textcolor lt -1 rotate by -270
set y2label  ''
set y2label  font "" textcolor lt -1 rotate by -270
set yrange [ 0.000 : 1.000 ] noreverse nowriteback
set y2range [ 0.000 : 1.000 ] noreverse nowriteback
set zlabel "" 
...
set output "Cap-Motors-Induccio-CaractMotor-3.tex"
set object rectangle from 0,0 to 1500,1 fillstyle solid fillcolor rgb "#FFFFF0" behind
set arrow from 1425.0, 0.8874 to 1425.0, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1425}{r/min}$}' at 1408, 0.2 center rotate by -270 front
set arrow from 1425.0, 0.8874 to 0.0, 0.8874 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,8874}$}' at 150, 0.91 center front
set arrow from 1425.0, 0.8761 to 0.0, 0.8761 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,8761}$}' at 150, 0.85 center front
plot "../Python/Auxiliars/Cap-Motors-Induccio-CaractMotor-Aux.txt" using 1:8 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$\cos\varphi$', "../Python/Auxiliars/Cap-Motors-Induccio-CaractMotor-Aux.txt" using 1:9 with lines axes x1y1 linecolor rgb "sea-green"  linewidth 6.000 title '$\eta$'
#    EOF
