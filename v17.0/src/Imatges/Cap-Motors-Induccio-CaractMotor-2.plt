...
set ytics 0.0,5.0,50.0 norangelimit textcolor rgb "black" 
...
set x2range [ 0.0000 : 1500.0000 ] noreverse nowriteback
set ylabel  '$P\ped{m}\, / \,\unit{kW}, \quad P\, / \,\unit{kW}, \quad Q\, / \,\unit{kvar}, \quad S\, / \,\unit{kVA}$'
set ylabel  font "" textcolor lt -1 rotate by -270
set y2label  ''
set y2label  font "" textcolor lt -1 rotate by -270
set yrange [ 0.000 : 50.000 ] noreverse nowriteback
set y2range [ 0.000 : 50.000 ] noreverse nowriteback
set zlabel "" 
...
set output "Cap-Motors-Induccio-CaractMotor-2.tex"
set object rectangle from 0,0 to 1500,50 fillstyle solid fillcolor rgb "#FFFFF0" behind
set arrow from 1425.0, 9.0528 to 0.0, 9.0528 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{9052,8}{W}$}' at 150, 7.8 center norotate front
set arrow from 1425.0, 29.0 to 1425.0, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1425}{r/min}$}' at 1408, 25 center rotate by -270 front
plot "../Python/Auxiliars/Cap-Motors-Induccio-CaractMotor-Aux.txt" using 1:4 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$P\ped{m}$', "../Python/Auxiliars/Cap-Motors-Induccio-CaractMotor-Aux.txt" using 1:5 with lines axes x1y1 linecolor rgb "sea-green"  linewidth 6.000 title '$P$', "../Python/Auxiliars/Cap-Motors-Induccio-CaractMotor-Aux.txt" using 1:6 with lines axes x1y1 linecolor rgb "orange"  linewidth 6.000 title '$Q$',"../Python/Auxiliars/Cap-Motors-Induccio-CaractMotor-Aux.txt" using 1:7 with lines axes x1y1 linecolor rgb "black"  linewidth 6.000 title '$S$'
#    EOF
