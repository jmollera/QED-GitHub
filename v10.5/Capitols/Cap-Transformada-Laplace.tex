...
\label{ex:laplace}
    ...
    \begin{dingautolist}{'312}
        ...
        \item Per començar premem la tecla \includegraphics{HPPrime-CAS.pdf} «computer algebra system», per tal de posar la calculadora en el mode de resolució simbòlic; a continuació premem la tecla \includegraphics{HPPrime-Tool.pdf} i escollim \textsf{Inverse Laplace} (funció \textsf{ilaplace}).
         ...
         \item A continuació premem el botó  \hpbutton{Copy}, premem el botó \hpbutton{Sto\hspace{1mm}\faCaretRight} i  escrivim  \textsf{F1(t)}.

             \includegraphics{Cap-Laplace-HPP5.png}\vspace{5mm}

         \item Finalment premem la tecla \includegraphics{HPPrime-Enter.pdf}. La variable \textsf{t} queda substituïda per la variable \textsf{X} i es crea la funció \textsf{F1(X)}.

          \includegraphics{Cap-Laplace-HPP6.png}\vspace{5mm}


         \item A continuació premem  la tecla \includegraphics{HPPrime-Apps.pdf} i seleccionem  l'aplicació \textsf{Function}.
