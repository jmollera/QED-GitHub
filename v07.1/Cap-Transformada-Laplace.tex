...
\begin{exemple}[C\`{a}lcul de transformades de Laplace]
...
\begin{center}
    ...
    \captionof{figure}{An\`{a}lisi de circuits mitjan\c{c}ant la transformada de Laplace}
...
\begin{exemple}[Resoluci\'{o} d'un circuit R-C]
...
\begin{exemple}[Resoluci\'{o} d'un circuit amb condicions inicial no nu{\l.l}es]
    ...
    Si en aquesta equaci\'{o}, fem $t=0$, tenim:
...
\begin{exemple}[Resoluci\'{o} d'un circuit amb condicions inicial nu{\l.l}es]
    El circuit de la figura seg\"{u}ent est\`{a} relaxat. En l'instant $t=0$
