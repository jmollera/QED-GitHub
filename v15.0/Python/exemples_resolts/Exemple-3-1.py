...
from qed.eng_elec import triangle_to_phasors, ABC_to_A012, AB12_to_AN12, A012_to_ABC, LL_to_LG

R = 10  # Ω

U_AB, U_BC, U_CA = triangle_to_phasors(2760, 1840, 2300)  # V
...
U_AG_1, U_AG_2 = AB12_to_AN12(U_AB_1, U_AB_2)
U_AG_0 = 0
