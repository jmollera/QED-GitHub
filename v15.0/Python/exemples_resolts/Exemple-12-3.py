...
tr = pp.create_transformer_from_parameters(net, hv_bus=b1, lv_bus=b2, sn_mva=1, vn_hv_kv=1, vn_lv_kv=1, vkr_percent=0, vk_percent=2, pfe_kw=0, i0_percent=0, tap_side='hv', tap_step_percent=1, tap_min=-10, tap_max=10, tap_neutral=0, tap_pos=0)
pp.create_load(net, b2, p_mw=2, q_mvar=1)

pc.ContinuousTapControl(net, tr, vm_set_pu=1, tol=1e-6)

pp.runpp(net, run_control=True)

print('\nTensions i potències del nusos')
print(net.res_bus)
tap_pos = net.trafo.tap_pos[tr]
