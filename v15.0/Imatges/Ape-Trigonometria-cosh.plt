...
set ytics 0.0, 10.0, 80.0 norangelimit textcolor rgb "black" 
...
set yrange [ 0.0 : 80.0 ] noreverse nowriteback
...
set output "Ape-Trigonometria-cosh.tex"
set object rectangle from -5.0,0.0 to 5.0,80.0 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot cosh(x) linecolor rgb "red"  linewidth 6.000
#    EOF