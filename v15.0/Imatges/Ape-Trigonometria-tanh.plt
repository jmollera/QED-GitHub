...
set ytics -1.0, 0.25, 1.0 norangelimit textcolor rgb "black" 
...
set yrange [ -1.0 : 1.0 ] noreverse nowriteback
...
set output "Ape-Trigonometria-tanh.tex"
set object rectangle from -5.0,-1.0 to 5.0,1.0 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot tanh(x) linecolor rgb "red"  linewidth 6.000
#    EOF