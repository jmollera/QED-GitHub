...
set ytics -5.0, 1.0, 5.0 norangelimit textcolor rgb "black" 
...
set yrange [ -5.0 : 5.0 ] noreverse nowriteback
...
set output "Ape-Trigonometria-coth.tex"
set object rectangle from -5.0,-5.0 to 5.0,5.0 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot 1/tanh(x) linecolor rgb "red"  linewidth 6.000
#    EOF