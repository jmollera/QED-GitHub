...
set key title ""
set key inside right top vertical Left reverse enhanced box
#set key at 270, 115  Left reverse  box
set key noinvert samplen 1 spacing 1.5 width -1 height 0.5 
...
set xtics 0.0,100.0,1500.0 norangelimit textcolor rgb "blackz" 
set ytics border out scale 1,0.5 nomirror norotate  autojustify
set ytics 0.0,10.0,150.0 norangelimit textcolor rgb "black" 
...
set y2tics 0.0,5.0,75.0 norangelimit textcolor rgb "black"
...
set xrange [ 0.0000 : 1500.0000 ] noreverse nowriteback
...
set yrange [ 0.000 : 150.000 ] noreverse nowriteback
set y2range [ 0.000 : 75.000 ] noreverse nowriteback
set zlabel "" 
...
set output "Cap-Motors-Induccio-MotTensRedIarr-1.tex"
set object rectangle from 0,0 to 1500,150 fillstyle solid fillcolor rgb "#FFFFF0" behind
set arrow from 1427.3, 56.4 to 0.0, 56.4 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{56,4}{N.m}$}' at 150, 52.5 center norotate front
set arrow from 1427.3, 56.4 to 1427.3, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1427,3}{r/min}$}' at 1412, 18 center rotate by -270 front
set arrow from 1170.5, 117.5 to 0.0, 117.5 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{117,5}{N.m}$}' at 150, 113.2 center norotate front
set arrow from 1170.5, 117.5 to 1170.5, 0.0 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{1170,5}{r/min}$}' at 1155, 20 center rotate by -270 front
set arrow from 1275, second 16.85 to 1500, second 16.85 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\qty{16,9}{A}$}' at 1330, second 18 center front
plot "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedIarr-Aux.txt" using 1:2 with lines axes x1y1 linecolor rgb "black" linewidth 6.000 title '$T\ped{load}$', "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedIarr-Aux.txt" using 1:3 with lines axes x1y1 linecolor rgb "red"  linewidth 6.000 title '$T\ped{m}$', "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedIarr-Aux.txt" using 1:4 with lines axes x1y2 linecolor rgb "orange"  linewidth 6.000 title '$I_1$'
#    EOF
