...
set xtics 0.75,0.05,1.0 norangelimit textcolor rgb "blackz" 
set ytics border out scale 1,0.5 nomirror norotate  autojustify
set ytics 0.76,0.02,0.9 norangelimit textcolor rgb "black" 
...
set output "Cap-Motors-Induccio-MotTensRedSolAp-2.tex"
set object rectangle from 0.75,0.76 to 1,0.9 fillstyle solid fillcolor rgb "#FFFFF0" behind
set arrow from 0.8, 0.8711 to 0.8,  0.76 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,8}$}' at 0.796, 0.77 center rotate by -270 front
set arrow from 0.8,  0.8711 to 0.75,  0.8711 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,8711}$}' at 0.775, 0.874 center front
set arrow from 0.8, 0.8163 to 0.75, 0.8163 dt 2 linecolor rgb "dark-violet" linewidth 3.0 head noborder back
set label '{$\scriptstyle\num{0,8163}$}' at 0.775, 0.812 center front
plot "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedSolAp-Aux.txt" using 1:4 with lines axes x1y1 linecolor rgb "red" linewidth 6.000 title '$\cos\varphi$', "../Python/Auxiliars/Cap-Motors-Induccio-MotTensRedSolAp-Aux.txt" using 1:5 with lines axes x1y1 linecolor rgb "sea-green"  linewidth 6.000 title '$\eta$'
#    EOF
