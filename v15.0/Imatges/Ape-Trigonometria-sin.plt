...
set output "Ape-Trigonometria-sin.tex"
set object rectangle from -2*pi,-1.0 to 2*pi,1.0 fillstyle solid fillcolor rgb "#FFFFF0" behind
plot sin(x) linecolor rgb "red"  linewidth 6.000
#    EOF