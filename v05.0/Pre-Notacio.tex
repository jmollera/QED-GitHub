...
\setlength{\labelsep}{5mm}}
    ...
    \item[$\psi$] Angle inicial de la funci\'{o} sinuso\"{\i}dal; $\psi=\omega t_0$ (vegeu el gr\`{a}fic a continuaci\'{o}). $\psi$ \'{e}s positiu quan es mesura des de l'origen cap a l'esquerra, fins a trobar el valor m\`{a}xim de la funci\'{o} sinuso\"{\i}dal, i \'{e}s negatiu quan es mesura cap a la dreta.
