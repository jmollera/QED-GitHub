...
\begin{exemple}[Control de tensi\'{o} d'un nus amb condensadors]\label{ex:control-v-cond}
...
S'utilitzar\`{a} en ambd\'{o}s casos els sistema d'equacions no lineals de l'exemple \vref{ex:control-v-cond}, \'{e}s a dir:
\begin{align*}
\num{-0,8} - |\cmplx{v}_2| \times \bigl( \num{1,05}\times [\num{-2,80}\times \cos(-\delta_2) - \num{9,60} \times
\sin( -\delta_2)]  + |\cmplx{v}_2| \times \num{2,80} \bigr) &= 0 \\
-\num{0,6} + |\cmplx{v}_2| \times\bigl( \num{1,05} \times[\num{-2,80}\times\sin(-\delta_2) +
