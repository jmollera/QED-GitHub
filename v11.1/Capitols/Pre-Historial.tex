...
S'actualitza l'apèndix \ref{sec:SI}  degut a l'entrada en vigor el 20 de maig de 2019 de la nova definició de les unitats fonamentals del Sistema Internacional d'Unitats (SI).

S'actualitza l'apèndix  \ref{sec:const_fis} amb els nous valors de les constants físiques recomanats l'any 2018 pel «Committee on Data for Science and Technology» (CODATA). Aquests canvis de  valors estan  relacionat amb la nova definició de les unitats fonamentals de l'SI, indicada en el paràgraf anterior. 