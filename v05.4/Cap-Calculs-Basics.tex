...
\begin{align*}
   \cmplx{Z}_{\alphaup} & = \frac{10\unit{\ohm}\times(-\ju10\unit{\ohm})}{10\unit{\ohm} - \ju10\unit{\ohm} - \ju10\unit{\ohm}} = 4 - \ju 2\unit{\ohm} \\[1.5ex]
   \cmplx{Z}_{\betaup} & = \frac{-\ju10\unit{\ohm}\times 10\unit{\ohm}}{10\unit{\ohm} - \ju10\unit{\ohm} - \ju10\unit{\ohm}} = 4 - \ju 2\unit{\ohm} \\[1.5ex]
\cmplx{Z}_{\gammaup} &=
\frac{-\ju10\unit{\ohm}\times(-\ju10\unit{\ohm})}{10\unit{\ohm} -
...
i $\cmplx{Z}^* \cmplx{S}$:
\begin{align*}
   \psi &= \arg(0{,}4 + \ju 0{,}3) = 0{,}6435\unit{rad} \\
   E' &= |0{,}4 + \ju 0{,}3| = 0{,5} \\
   \cmplx{Z}^* \cmplx{S} &= - \ju 0{,}1 \times (0{,}6 + \ju 0{,}45) = 0{,}045 - \ju 0{,}06
\end{align*}
...
\begin{align*}
   \Re^2(\cmplx{U}') + (-0{,}12)^2 - 0{,}5 \times \Re(\cmplx{U}') + 0{,}045 &= 0 \\
   \Re^2(\cmplx{U}') - 0{,}5 \times \Re(\cmplx{U}') + 0{,}0594 &= 0  \;\rightarrow\; \Re(\cmplx{U}') =
   \left\{ \begin{matrix}
     0{,}1943 \\
     \boxed{0{,}3057}
   \end{matrix}
...
\[
   \cmplx{U} = \cmplx{U}' \, \eu^{\ju \psi} = (0{,}3057 - \ju 0{,}12) \times \eu^{\ju 0{,}6435} =
   0{,}3165 + \ju 0{,}0874
\]
...
\begin{align*}
   &a)\;I\ped{F} = \frac{850\unit{kVA}}{\sqrt{3}\times 400\unit{V}\times
   \left(\dfrac{850\unit{kVA}}{200\unit{MVA}} +
   0{,}05\right)} = 22{,}6\unit{kA} \\[1ex]
   &b)\;I\ped{F} = \frac{850\unit{kVA}}{\sqrt{3}\times 400\unit{V}\times
   0{,}05} = 24{,}5\unit{kA}
\end{align*}
...
\[
    D = 56\unit{mm} \times (\log 5 - 0)  = 39{,}1\unit{mm}
\]
\end{exemple}
