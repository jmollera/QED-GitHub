...
\section{\`{A}mbit d'aplicaci\'{o} de diverses Normes CEI}\index{CEI}

Es relacionen a continuaci\'{o} diverses normes \textsf{CEI} agrupades per \`{a}mbit d'aplicaci\'{o}. Podeu trobar el llistat complet de les normes \textsf{CEI} a l'adre\c{c}a;  \href{http://www.iec.ch/standardsdev/publications/}{www.iec.ch/standardsdev/publications/}.

\textbf{Aparellatge de baixa tensi\'{o}:}
\begin{dinglist}{'167}
...
\textbf{Coordinaci\'{o} d'a\"{\i}llaments:}
\begin{dinglist}{'167}
...
\textbf{Fusibles de baixa tensi\'{o}:}
\begin{dinglist}{'167}
...
\textbf{Termoparells:} \index{termoparells}
\begin{dinglist}{'167}
...
\textbf{Transformadors de mesura i protecci\'{o}:}
\begin{dinglist}{'167}
...
\textbf{Transformadors de pot\`{e}ncia:}
\begin{dinglist}{'167}
...
\section{\`{A}mbit d'aplicaci\'{o} de diverses Normes IEEE}\index{IEEE}

Es relacionen a continuaci\'{o} diverses normes \textsf{IEEE} agrupades per \`{a}mbit d'aplicaci\'{o}. Podeu trobar el llistat complet de les normes \textsf{IEEE} a l'adre\c{c}a: \href{http://ieeexplore.ieee.org/xpl/standards.jsp}{ieeexplore.ieee.org/xpl/standards.jsp}.

\textbf{Bateries i altres equips de corrent continu:}
\begin{dinglist}{'167}
...
\textbf{Centrals el\`{e}ctriques i subestacions:}
\begin{dinglist}{'167}
...
\textbf{Equips nuclears i classe 1E - Criteris:} \index{classe 1E}
\begin{dinglist}{'167}
...
\textbf{Equips nuclears i classe 1E - Disseny, insta{\l.l}aci\'{o} i proves:}
\begin{dinglist}{'167}
...
\textbf{Equips nuclears i classe 1E - Qualificaci\'{o}:}
\begin{dinglist}{'167}
...
\textbf{Interruptors d'alta tensi\'{o}:}
\begin{dinglist}{'167}
    \item \textbf{IEEE C37.04}. Rating Structure for AC High-Voltage Circuit Breakers.\index{IEEE!C37.04}
    \item \textbf{IEEE C37.06}. AC High-Voltage Circuit Breakers Rated on a Symmetrical Current Basis.\index{IEEE!C37.06}
    ...
    \item \textbf{IEEE C37.13}. AC High-Voltage Generator Circuit Breakers Rated on a Symmetrical Current Basis.\index{IEEE!C37.13}
\end{dinglist}


\textbf{Interruptors de baixa tensi\'{o}:}
\begin{dinglist}{'167}
    \item \textbf{IEEE C37.04}. Rating Structure for AC High-Voltage Circuit Breakers.\index{IEEE!C37.04}
...
\break
\textbf{Penetracions el\`{e}ctriques:}
\begin{dinglist}{'167}
...
\textbf{Proteccions el\`{e}ctriques:}
\begin{dinglist}{'167}
...
\textbf{Representaci\'{o} i simbologia:}
\begin{dinglist}{'167}
